...
Waarom dit bestaat: 1253 servermodules en 5061 endpoints houdt niemand in zijn hoofd.
...
Daarnaast 3435 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
