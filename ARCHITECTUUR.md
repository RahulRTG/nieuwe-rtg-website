...
Waarom dit bestaat: 1253 servermodules en 4076 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 4076 |
| servermodules (`server/**/*.js`) | 2293 |
| routebestanden (`server/routes/**`) | 473 |
| kernmodules (`server/kern/**`) | 1402 |
| schermen (`public/**/*.html`) | 264 |
| gedeelde browsermodules (`public/shared/*.js`) | 229 |
| toetsbestanden (`test/*.test.js`) | 948 |
| schermtoetsen (`test/*.e2e.js`) | 136 |
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1417 |
