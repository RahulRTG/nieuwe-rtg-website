...
Waarom dit bestaat: 1253 servermodules en 4121 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 4121 |
| servermodules (`server/**/*.js`) | 2357 |
| routebestanden (`server/routes/**`) | 482 |
| kernmodules (`server/kern/**`) | 1439 |
...
Daarnaast 2339 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
