...
|---|---|
| API-endpoints | 5008 |
| servermodules (`server/**/*.js`) | 3337 |
| routebestanden (`server/routes/**`) | 578 |
| kernmodules (`server/kern/**`) | 2080 |
| schermen (`public/**/*.html`) | 315 |
...
```
app(201) auth(122) supplierAuth(64) officeAuth(45) db(38) liveCodename(35) status(31)
