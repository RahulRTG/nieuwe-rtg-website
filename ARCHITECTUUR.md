...
|---|---|
| API-endpoints | 2904 |
| servermodules (`server/**/*.js`) | 1594 |
| routebestanden (`server/routes/**`) | 353 |
| kernmodules (`server/kern/**`) | 930 |
| schermen (`public/**/*.html`) | 219 |
...
zie §5 -- er zijn nog 148 kern-namen die meer dan één domein aanraakt.
...
Daarnaast 1515 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| daarvan door **meer dan één** domein (de echte koppeling) | 148 |
...
```
app(130) auth(75) supplierAuth(46) db(30) officeAuth(29) accounts(18) liveCodename(17)
status(16) schoon(15) managerOnly(12) codenaamVan(12) rtf(11) express(10) save(10)
anthropic(10) tooManyTries(9) crypto(9) rtmail(9) boardroomWie(7) logActivity(7)
