...
Waarom dit bestaat: 1253 servermodules en 2771 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 2771 |
| servermodules (`server/**/*.js`) | 1462 |
| routebestanden (`server/routes/**`) | 339 |
| kernmodules (`server/kern/**`) | 823 |
...
Daarnaast 1424 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1100 |
| daarvan door **meer dan één** domein (de echte koppeling) | 141 |
| daarvan door precies één domein | 959 |
