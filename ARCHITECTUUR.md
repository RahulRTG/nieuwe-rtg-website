...
Waarom dit bestaat: 1253 servermodules en 2899 endpoints houdt niemand in zijn hoofd.
...
Daarnaast 1510 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
```
app(127) auth(72) supplierAuth(46) db(30) officeAuth(29) accounts(18) liveCodename(17)
