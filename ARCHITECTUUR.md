...
Waarom dit bestaat: 1253 servermodules en 4902 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 4902 |
| servermodules (`server/**/*.js`) | 3054 |
| routebestanden (`server/routes/**`) | 554 |
| kernmodules (`server/kern/**`) | 1936 |
...
Daarnaast 3307 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1530 |
