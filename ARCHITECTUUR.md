...
Waarom dit bestaat: 1253 servermodules en 2835 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 2835 |
| servermodules (`server/**/*.js`) | 1493 |
| routebestanden (`server/routes/**`) | 343 |
| kernmodules (`server/kern/**`) | 851 |
| schermen (`public/**/*.html`) | 212 |
...
Daarnaast 1485 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| daarvan door precies één domein | 949 |
