...
Waarom dit bestaat: 1253 servermodules en 2953 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 2953 |
| servermodules (`server/**/*.js`) | 1603 |
| routebestanden (`server/routes/**`) | 363 |
| kernmodules (`server/kern/**`) | 927 |
| schermen (`public/**/*.html`) | 221 |
| gedeelde browsermodules (`public/shared/*.js`) | 172 |
| toetsbestanden (`test/*.test.js`) | 653 |
| schermtoetsen (`test/*.e2e.js`) | 97 |
...
Daarnaast 1555 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1179 |
| daarvan door **meer dan één** domein (de echte koppeling) | 146 |
| daarvan door precies één domein | 1033 |
...
```
app(140) auth(86) supplierAuth(46) db(30) officeAuth(29) status(27) liveCodename(21)
