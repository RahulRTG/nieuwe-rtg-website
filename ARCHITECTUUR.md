...
Waarom dit bestaat: 1253 servermodules en 2992 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 2992 |
| servermodules (`server/**/*.js`) | 1611 |
| routebestanden (`server/routes/**`) | 357 |
| kernmodules (`server/kern/**`) | 939 |
...
Daarnaast 1603 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
