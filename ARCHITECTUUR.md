...
Waarom dit bestaat: 1253 servermodules en 4105 endpoints houdt niemand in zijn hoofd.
...
Daarnaast 2326 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1419 |
| daarvan door **meer dan één** domein (de echte koppeling) | 194 |
| daarvan door precies één domein | 1225 |
...
```
app(174) auth(106) supplierAuth(55) officeAuth(37) db(36) status(27) liveCodename(26)
...
notifySupplier(6) boardroomAuth(6) pay(6) talen(6) appUrl(5) loginFails(5) logInlog(5)
