...
Waarom dit bestaat: 1253 servermodules en 3878 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 3878 |
| servermodules (`server/**/*.js`) | 2092 |
| routebestanden (`server/routes/**`) | 441 |
| kernmodules (`server/kern/**`) | 1287 |
| schermen (`public/**/*.html`) | 253 |
| gedeelde browsermodules (`public/shared/*.js`) | 220 |
| toetsbestanden (`test/*.test.js`) | 846 |
...
zie §5 -- er zijn nog 185 kern-namen die meer dan één domein aanraakt.

| Domein | Endpoints | Routebestanden | Zonder bewaker | Bereik in kern |
|---|---|---|---|---|
| `auth` | 19 | 5 | 8 | 46 |
| `member` | 641 | 56 | 10 | 398 |
| `supplier` | 561 | 102 | 10 | 293 |
| `office` | 39 | 7 | 3 | 58 |
| `staff` | 26 | 7 | 1 | 40 |
| `social` | 55 | 7 | 31 | 52 |
| `techniek` | 53 | 13 | 1 | 51 |
...
Daarnaast 2167 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1385 |
| daarvan door **meer dan één** domein (de echte koppeling) | 185 |
| daarvan door precies één domein | 1200 |
...
```
app(165) auth(101) supplierAuth(53) officeAuth(34) db(34) status(27) liveCodename(25)
accounts(20) schoon(20) managerOnly(15) rtf(15) codenaamVan(15) save(14) anthropic(13)
crypto(11) tooManyTries(10) boardroomWie(10) express(9) gegevensStop(9) payrollOS(9)
keyVanCodenaam(9) rtmail(9) geenGast(8) findSupplier(8) noteFailedTry(7) kern(7)
logActivity(7) sseToOffice(7) stuur(6) talen(6) mail(5) loginFails(5) sseToSupplier(5)
