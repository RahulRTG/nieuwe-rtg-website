...
Waarom dit bestaat: 1253 servermodules en 5137 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 5137 |
| servermodules (`server/**/*.js`) | 3657 |
| routebestanden (`server/routes/**`) | 609 |
| kernmodules (`server/kern/**`) | 2289 |
| schermen (`public/**/*.html`) | 320 |
| gedeelde browsermodules (`public/shared/*.js`) | 390 |
| toetsbestanden (`test/*.test.js`) | 1767 |
...
Daarnaast 3503 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
