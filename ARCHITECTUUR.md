...
Waarom dit bestaat: 1253 servermodules en 5053 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 5053 |
| servermodules (`server/**/*.js`) | 3481 |
| routebestanden (`server/routes/**`) | 591 |
| kernmodules (`server/kern/**`) | 2173 |
| schermen (`public/**/*.html`) | 318 |
| gedeelde browsermodules (`public/shared/*.js`) | 353 |
| toetsbestanden (`test/*.test.js`) | 1657 |
...
Daarnaast 3427 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1578 |
| daarvan door **meer dan één** domein (de echte koppeling) | 237 |
| daarvan door precies één domein | 1341 |
...
```
app(205) auth(126) supplierAuth(64) officeAuth(46) db(38) liveCodename(35) status(31)
