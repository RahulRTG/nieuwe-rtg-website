...
Waarom dit bestaat: 1253 servermodules en 4118 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 4118 |
| servermodules (`server/**/*.js`) | 2333 |
| routebestanden (`server/routes/**`) | 480 |
| kernmodules (`server/kern/**`) | 1432 |
