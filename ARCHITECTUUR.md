...
Waarom dit bestaat: 1253 servermodules en 2998 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 2998 |
| servermodules (`server/**/*.js`) | 1614 |
| routebestanden (`server/routes/**`) | 357 |
| kernmodules (`server/kern/**`) | 942 |
...
Daarnaast 1609 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
