...
Waarom dit bestaat: 1253 servermodules en 2759 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 2759 |
| servermodules (`server/**/*.js`) | 1459 |
| routebestanden (`server/routes/**`) | 339 |
| kernmodules (`server/kern/**`) | 820 |
...
Daarnaast 1412 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1088 |
| daarvan door **meer dan één** domein (de echte koppeling) | 140 |
| daarvan door precies één domein | 948 |
