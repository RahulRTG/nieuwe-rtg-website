...
Waarom dit bestaat: 1253 servermodules en 3863 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 3863 |
| servermodules (`server/**/*.js`) | 2075 |
| routebestanden (`server/routes/**`) | 435 |
| kernmodules (`server/kern/**`) | 1281 |
...
Daarnaast 2161 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1382 |
| daarvan door **meer dan één** domein (de echte koppeling) | 184 |
| daarvan door precies één domein | 1198 |
