...
Waarom dit bestaat: 1253 servermodules en 2941 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 2941 |
| servermodules (`server/**/*.js`) | 1593 |
| routebestanden (`server/routes/**`) | 359 |
| kernmodules (`server/kern/**`) | 923 |
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1167 |
| daarvan door **meer dan één** domein (de echte koppeling) | 146 |
| daarvan door precies één domein | 1021 |
...
```
app(136) auth(82) supplierAuth(46) db(30) officeAuth(29) status(24) liveCodename(20)
