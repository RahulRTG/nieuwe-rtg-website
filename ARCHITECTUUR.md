...
| toetsbestanden (`test/*.test.js`) | 1658 |
...
zie §5 -- er zijn nog 236 kern-namen die meer dan één domein aanraakt.
...
| daarvan door **meer dan één** domein (de echte koppeling) | 236 |
