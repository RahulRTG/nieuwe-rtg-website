...
|---|---|
| API-endpoints | 4042 |
| servermodules (`server/**/*.js`) | 2280 |
| routebestanden (`server/routes/**`) | 466 |
| kernmodules (`server/kern/**`) | 1381 |
| schermen (`public/**/*.html`) | 256 |
| gedeelde browsermodules (`public/shared/*.js`) | 243 |
| toetsbestanden (`test/*.test.js`) | 972 |
...
zie §5 -- er zijn nog 197 kern-namen die meer dan één domein aanraakt.

| Domein | Endpoints | Routebestanden | Zonder bewaker | Bereik in kern |
|---|---|---|---|---|
| `auth` | 19 | 5 | 8 | 53 |
| `member` | 641 | 57 | 10 | 400 |
| `supplier` | 564 | 103 | 10 | 295 |
| `office` | 48 | 9 | 6 | 70 |
| `staff` | 26 | 8 | 1 | 42 |
| `social` | 71 | 9 | 39 | 60 |
| `techniek` | 58 | 15 | 1 | 51 |
...
Daarnaast 2298 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1436 |
| daarvan door **meer dan één** domein (de echte koppeling) | 197 |
| daarvan door precies één domein | 1239 |
...
```
app(172) auth(106) supplierAuth(55) officeAuth(36) db(35) status(27) liveCodename(27)
