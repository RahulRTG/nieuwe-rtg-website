...
Waarom dit bestaat: 1253 servermodules en 3838 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 3838 |
| servermodules (`server/**/*.js`) | 2072 |
| routebestanden (`server/routes/**`) | 434 |
| kernmodules (`server/kern/**`) | 1279 |
| schermen (`public/**/*.html`) | 253 |
| gedeelde browsermodules (`public/shared/*.js`) | 220 |
| toetsbestanden (`test/*.test.js`) | 838 |
...
zie §5 -- er zijn nog 183 kern-namen die meer dan één domein aanraakt.
...
Daarnaast 2136 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1377 |
| daarvan door **meer dan één** domein (de echte koppeling) | 183 |
| daarvan door precies één domein | 1194 |
