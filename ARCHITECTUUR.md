...
Waarom dit bestaat: 1253 servermodules en 5074 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 5074 |
| servermodules (`server/**/*.js`) | 3531 |
| routebestanden (`server/routes/**`) | 594 |
| kernmodules (`server/kern/**`) | 2207 |
...
Daarnaast 3447 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
