...
Waarom dit bestaat: 1253 servermodules en 5131 endpoints houdt niemand in zijn hoofd.
...
zie §5 -- er zijn nog 242 kern-namen die meer dan één domein aanraakt.
...
Daarnaast 3497 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
