...
Waarom dit bestaat: 1253 servermodules en 4927 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 4927 |
| servermodules (`server/**/*.js`) | 3092 |
| routebestanden (`server/routes/**`) | 561 |
| kernmodules (`server/kern/**`) | 1961 |
| schermen (`public/**/*.html`) | 291 |
| gedeelde browsermodules (`public/shared/*.js`) | 313 |
| toetsbestanden (`test/*.test.js`) | 1366 |
| schermtoetsen (`test/*.e2e.js`) | 199 |
...
Daarnaast 3332 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1535 |
| daarvan door **meer dan één** domein (de echte koppeling) | 227 |
| daarvan door precies één domein | 1308 |
...
```
app(197) auth(119) supplierAuth(64) officeAuth(45) db(37) liveCodename(35) status(29)
