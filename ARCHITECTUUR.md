...
Waarom dit bestaat: 1253 servermodules en 2733 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 2733 |
| servermodules (`server/**/*.js`) | 1433 |
| routebestanden (`server/routes/**`) | 336 |
| kernmodules (`server/kern/**`) | 802 |
| schermen (`public/**/*.html`) | 209 |
| gedeelde browsermodules (`public/shared/*.js`) | 162 |
| toetsbestanden (`test/*.test.js`) | 585 |
...
Daarnaast 1386 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1059 |
