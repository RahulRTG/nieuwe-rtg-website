...
Waarom dit bestaat: 1253 servermodules en 4034 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 4034 |
| servermodules (`server/**/*.js`) | 2224 |
| routebestanden (`server/routes/**`) | 463 |
| kernmodules (`server/kern/**`) | 1357 |
...
Daarnaast 2301 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
