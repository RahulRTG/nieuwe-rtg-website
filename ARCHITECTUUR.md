...
Waarom dit bestaat: 1253 servermodules en 4032 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 4032 |
| servermodules (`server/**/*.js`) | 2252 |
| routebestanden (`server/routes/**`) | 464 |
| kernmodules (`server/kern/**`) | 1384 |
...
Daarnaast 2285 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
