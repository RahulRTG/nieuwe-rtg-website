...
Waarom dit bestaat: 1253 servermodules en 3924 endpoints houdt niemand in zijn hoofd.
...
zie §5 -- er zijn nog 186 kern-namen die meer dan één domein aanraakt.
...
Daarnaast 2213 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| daarvan door **meer dan één** domein (de echte koppeling) | 186 |
...
payrollOS(9) keyVanCodenaam(9) rtmail(9) findSupplier(8) noteFailedTry(7) kern(7)
