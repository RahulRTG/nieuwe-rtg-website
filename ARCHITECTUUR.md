...
Daarnaast 1388 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1067 |
| daarvan door **meer dan één** domein (de echte koppeling) | 142 |
| daarvan door precies één domein | 925 |
...
```
app(122) auth(70) supplierAuth(46) db(30) officeAuth(27) accounts(18) liveCodename(17)
