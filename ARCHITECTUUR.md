...
Waarom dit bestaat: 1253 servermodules en 5069 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 5069 |
| servermodules (`server/**/*.js`) | 3528 |
| routebestanden (`server/routes/**`) | 593 |
| kernmodules (`server/kern/**`) | 2205 |
...
Daarnaast 3441 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
