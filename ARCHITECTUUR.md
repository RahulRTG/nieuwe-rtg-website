...
Waarom dit bestaat: 1253 servermodules en 4758 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 4758 |
| servermodules (`server/**/*.js`) | 2867 |
| routebestanden (`server/routes/**`) | 542 |
| kernmodules (`server/kern/**`) | 1802 |
...
Daarnaast 3186 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
