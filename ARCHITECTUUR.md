...
Waarom dit bestaat: 1253 servermodules en 4088 endpoints houdt niemand in zijn hoofd.
...
Daarnaast 2308 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
