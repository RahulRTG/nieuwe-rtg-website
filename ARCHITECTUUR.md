...
Waarom dit bestaat: 1253 servermodules en 4009 endpoints houdt niemand in zijn hoofd.
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1421 |
...
```
app(171) auth(103) supplierAuth(57) officeAuth(37) db(35) status(27) liveCodename(25)
accounts(23) schoon(22) managerOnly(16) rtf(15) codenaamVan(15) save(14)
