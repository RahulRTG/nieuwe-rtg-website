...
Waarom dit bestaat: 1253 servermodules en 2940 endpoints houdt niemand in zijn hoofd.
...
Daarnaast 1542 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1166 |
| daarvan door **meer dan één** domein (de echte koppeling) | 146 |
| daarvan door precies één domein | 1020 |
...
```
app(135) auth(81) supplierAuth(46) db(30) officeAuth(29) status(24) liveCodename(19)
