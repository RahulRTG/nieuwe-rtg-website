...
Waarom dit bestaat: 1253 servermodules en 5093 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 5093 |
| servermodules (`server/**/*.js`) | 3550 |
| routebestanden (`server/routes/**`) | 595 |
...
Daarnaast 3466 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
