...
Waarom dit bestaat: 1253 servermodules en 2910 endpoints houdt niemand in zijn hoofd.
...
Daarnaast 1521 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
```
app(126) auth(71) supplierAuth(47) db(30) officeAuth(29) accounts(18) liveCodename(18)
