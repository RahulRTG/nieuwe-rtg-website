...
Waarom dit bestaat: 1253 servermodules en 5146 endpoints houdt niemand in zijn hoofd.
...
Daarnaast 3512 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
