...
Waarom dit bestaat: 1253 servermodules en 4154 endpoints houdt niemand in zijn hoofd.
...
Daarnaast 2370 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
```
app(176) auth(108) supplierAuth(56) officeAuth(39) db(36) status(27) liveCodename(27)
...
notifySupplier(6) boardroomAuth(6) pay(6) talen(6) appUrl(5) onboarding(5) tenant(5)
