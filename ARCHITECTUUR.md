...
Waarom dit bestaat: 1253 servermodules en 4877 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 4877 |
| servermodules (`server/**/*.js`) | 3043 |
| routebestanden (`server/routes/**`) | 552 |
| kernmodules (`server/kern/**`) | 1929 |
| schermen (`public/**/*.html`) | 285 |
| gedeelde browsermodules (`public/shared/*.js`) | 310 |
| toetsbestanden (`test/*.test.js`) | 1344 |
| schermtoetsen (`test/*.e2e.js`) | 194 |
...
Daarnaast 3282 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1523 |
| daarvan door **meer dan één** domein (de echte koppeling) | 221 |
| daarvan door precies één domein | 1302 |
...
```
app(191) auth(117) supplierAuth(63) officeAuth(42) db(37) liveCodename(35) status(28)
