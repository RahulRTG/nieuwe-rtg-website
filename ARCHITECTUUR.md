...
Waarom dit bestaat: 1253 servermodules en 5130 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 5130 |
| servermodules (`server/**/*.js`) | 3634 |
| routebestanden (`server/routes/**`) | 604 |
| kernmodules (`server/kern/**`) | 2273 |
| schermen (`public/**/*.html`) | 320 |
| gedeelde browsermodules (`public/shared/*.js`) | 386 |
| toetsbestanden (`test/*.test.js`) | 1752 |
...
Daarnaast 3496 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
