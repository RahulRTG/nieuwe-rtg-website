...
Waarom dit bestaat: 1253 servermodules en 4876 endpoints houdt niemand in zijn hoofd.
...
zie §5 -- er zijn nog 216 kern-namen die meer dan één domein aanraakt.
...
Daarnaast 3281 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1518 |
| daarvan door **meer dan één** domein (de echte koppeling) | 216 |
...
```
app(190) auth(117) supplierAuth(63) officeAuth(41) db(37) liveCodename(35) status(29)
