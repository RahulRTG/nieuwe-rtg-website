...
Waarom dit bestaat: 1253 servermodules en 2754 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 2754 |
| servermodules (`server/**/*.js`) | 1448 |
| routebestanden (`server/routes/**`) | 339 |
| kernmodules (`server/kern/**`) | 809 |
