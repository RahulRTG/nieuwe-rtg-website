...
Waarom dit bestaat: 1253 servermodules en 3912 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 3912 |
| servermodules (`server/**/*.js`) | 2085 |
| routebestanden (`server/routes/**`) | 437 |
| kernmodules (`server/kern/**`) | 1289 |
...
Daarnaast 2209 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1391 |
| daarvan door **meer dan één** domein (de echte koppeling) | 185 |
| daarvan door precies één domein | 1206 |
