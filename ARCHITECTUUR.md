...
Waarom dit bestaat: 1253 servermodules en 3836 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 3836 |
| servermodules (`server/**/*.js`) | 2086 |
| routebestanden (`server/routes/**`) | 438 |
| kernmodules (`server/kern/**`) | 1284 |
| schermen (`public/**/*.html`) | 251 |
| gedeelde browsermodules (`public/shared/*.js`) | 219 |
| toetsbestanden (`test/*.test.js`) | 839 |
...
zie §5 -- er zijn nog 182 kern-namen die meer dan één domein aanraakt.
...
Daarnaast 2126 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1379 |
| daarvan door **meer dan één** domein (de echte koppeling) | 182 |
| daarvan door precies één domein | 1197 |
...
```
app(163) auth(100) supplierAuth(52) db(34) officeAuth(33) status(27) liveCodename(25)
