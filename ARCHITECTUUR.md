...
Waarom dit bestaat: 1253 servermodules en 5089 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 5089 |
| servermodules (`server/**/*.js`) | 3537 |
| routebestanden (`server/routes/**`) | 594 |
| kernmodules (`server/kern/**`) | 2211 |
...
Daarnaast 3462 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
