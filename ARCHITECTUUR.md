...
|---|---|
| API-endpoints | 4708 |
| servermodules (`server/**/*.js`) | 2792 |
| routebestanden (`server/routes/**`) | 537 |
| kernmodules (`server/kern/**`) | 1746 |
| schermen (`public/**/*.html`) | 275 |
| gedeelde browsermodules (`public/shared/*.js`) | 270 |
| toetsbestanden (`test/*.test.js`) | 1189 |
| schermtoetsen (`test/*.e2e.js`) | 172 |
