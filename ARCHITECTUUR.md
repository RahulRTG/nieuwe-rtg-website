...
Waarom dit bestaat: 1253 servermodules en 3239 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 3239 |
| servermodules (`server/**/*.js`) | 1853 |
| routebestanden (`server/routes/**`) | 391 |
| kernmodules (`server/kern/**`) | 1121 |
...
Daarnaast 1743 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
