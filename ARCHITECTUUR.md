...
Waarom dit bestaat: 1253 servermodules en 3985 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 3985 |
| servermodules (`server/**/*.js`) | 2175 |
| routebestanden (`server/routes/**`) | 451 |
| kernmodules (`server/kern/**`) | 1337 |
...
zie §5 -- er zijn nog 190 kern-namen die meer dan één domein aanraakt.

| Domein | Endpoints | Routebestanden | Zonder bewaker | Bereik in kern |
|---|---|---|---|---|
| `auth` | 19 | 5 | 8 | 46 |
| `member` | 641 | 57 | 10 | 398 |
| `supplier` | 564 | 103 | 10 | 294 |
| `office` | 40 | 7 | 5 | 64 |
| `staff` | 26 | 7 | 1 | 40 |
| `social` | 55 | 7 | 31 | 52 |
| `techniek` | 57 | 14 | 1 | 51 |
...
Daarnaast 2266 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1400 |
| daarvan door **meer dan één** domein (de echte koppeling) | 190 |
| daarvan door precies één domein | 1210 |
...
```
app(167) auth(102) supplierAuth(54) officeAuth(35) db(34) status(27) liveCodename(26)
accounts(21) schoon(20) managerOnly(16) rtf(15) codenaamVan(15) save(14)
tooManyTries(11) boardroomWie(11) crypto(11) anthropic(11) geenGast(10) express(9)
