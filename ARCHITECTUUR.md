...
Waarom dit bestaat: 1253 servermodules en 2764 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 2764 |
| servermodules (`server/**/*.js`) | 1460 |
| routebestanden (`server/routes/**`) | 339 |
| kernmodules (`server/kern/**`) | 821 |
| schermen (`public/**/*.html`) | 210 |
| gedeelde browsermodules (`public/shared/*.js`) | 161 |
| toetsbestanden (`test/*.test.js`) | 606 |
| schermtoetsen (`test/*.e2e.js`) | 79 |
...
Daarnaast 1417 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1093 |
| daarvan door **meer dan één** domein (de echte koppeling) | 141 |
| daarvan door precies één domein | 952 |
...
```
app(125) auth(71) supplierAuth(46) db(30) officeAuth(28) accounts(18) liveCodename(17)
