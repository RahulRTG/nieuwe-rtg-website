...
Waarom dit bestaat: 1253 servermodules en 5038 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 5038 |
| servermodules (`server/**/*.js`) | 3385 |
| routebestanden (`server/routes/**`) | 587 |
| kernmodules (`server/kern/**`) | 2110 |
| schermen (`public/**/*.html`) | 318 |
| gedeelde browsermodules (`public/shared/*.js`) | 351 |
| toetsbestanden (`test/*.test.js`) | 1602 |
...
zie §5 -- er zijn nog 235 kern-namen die meer dan één domein aanraakt.

| Domein | Endpoints | Routebestanden | Zonder bewaker | Bereik in kern |
|---|---|---|---|---|
| `auth` | 20 | 6 | 8 | 52 |
| `member` | 696 | 70 | 16 | 427 |
| `supplier` | 622 | 124 | 6 | 333 |
| `office` | 70 | 20 | 3 | 82 |
| `staff` | 26 | 8 | 1 | 42 |
| `social` | 76 | 10 | 31 | 71 |
| `techniek` | 77 | 19 | 1 | 64 |
...
Daarnaast 3413 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
```
app(204) auth(125) supplierAuth(64) officeAuth(45) db(38) liveCodename(35) status(31)
