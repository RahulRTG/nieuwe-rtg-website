...
Waarom dit bestaat: 1253 servermodules en 2952 endpoints houdt niemand in zijn hoofd.
...
| routebestanden (`server/routes/**`) | 362 |
| kernmodules (`server/kern/**`) | 926 |
| schermen (`public/**/*.html`) | 220 |
| gedeelde browsermodules (`public/shared/*.js`) | 172 |
| toetsbestanden (`test/*.test.js`) | 649 |
| schermtoetsen (`test/*.e2e.js`) | 96 |
...
Daarnaast 1554 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1178 |
| daarvan door **meer dan één** domein (de echte koppeling) | 146 |
| daarvan door precies één domein | 1032 |
...
```
app(139) auth(85) supplierAuth(46) db(30) officeAuth(29) status(27) liveCodename(20)
accounts(18) schoon(14) managerOnly(12) rtf(11) express(10) save(10) codenaamVan(10)
