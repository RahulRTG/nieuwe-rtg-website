...
Waarom dit bestaat: 1253 servermodules en 5142 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 5142 |
| servermodules (`server/**/*.js`) | 3665 |
| routebestanden (`server/routes/**`) | 610 |
| kernmodules (`server/kern/**`) | 2295 |
| schermen (`public/**/*.html`) | 320 |
| gedeelde browsermodules (`public/shared/*.js`) | 390 |
| toetsbestanden (`test/*.test.js`) | 1780 |
...
Daarnaast 3508 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
