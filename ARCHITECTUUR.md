...
Waarom dit bestaat: 1253 servermodules en 5150 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 5150 |
| servermodules (`server/**/*.js`) | 3718 |
| routebestanden (`server/routes/**`) | 613 |
| kernmodules (`server/kern/**`) | 2341 |
| schermen (`public/**/*.html`) | 320 |
| gedeelde browsermodules (`public/shared/*.js`) | 390 |
| toetsbestanden (`test/*.test.js`) | 1786 |
...
Daarnaast 3516 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
