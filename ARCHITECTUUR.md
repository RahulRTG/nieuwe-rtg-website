...
Waarom dit bestaat: 1253 servermodules en 2909 endpoints houdt niemand in zijn hoofd.
...
Daarnaast 1520 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1134 |
| daarvan door **meer dan één** domein (de echte koppeling) | 146 |
| daarvan door precies één domein | 988 |
...
```
app(129) auth(75) supplierAuth(46) db(30) officeAuth(29) liveCodename(19) accounts(18)
status(18) schoon(14) managerOnly(12) rtf(11) express(10) save(10) codenaamVan(10)
