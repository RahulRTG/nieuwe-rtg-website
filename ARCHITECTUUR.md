...
Waarom dit bestaat: 1253 servermodules en 3853 endpoints houdt niemand in zijn hoofd.
...
|---|---|
| API-endpoints | 3853 |
| servermodules (`server/**/*.js`) | 2089 |
| routebestanden (`server/routes/**`) | 440 |
| kernmodules (`server/kern/**`) | 1285 |
| schermen (`public/**/*.html`) | 253 |
| gedeelde browsermodules (`public/shared/*.js`) | 220 |
| toetsbestanden (`test/*.test.js`) | 845 |
...
zie §5 -- er zijn nog 184 kern-namen die meer dan één domein aanraakt.
...
Daarnaast 2142 `/api/`-endpoints buiten deze acht: de infra (health, stream, push,
...
| Meting | Nu |
|---|---|
| kern-namen die routes aanraken | 1380 |
| daarvan door **meer dan één** domein (de echte koppeling) | 184 |
| daarvan door precies één domein | 1196 |
...
```
app(164) auth(100) supplierAuth(52) db(34) officeAuth(33) status(27) liveCodename(25)
accounts(20) schoon(20) managerOnly(15) codenaamVan(15) save(14) rtf(14) anthropic(13)
