...
`public/apps/app-main/` -- 84 delen, 8881 regels in de delen
...
`public/apps/backoffice/` -- 6 delen, 771 regels in de delen
...
`public/apps/schoolpartner/app/` -- 2 delen, 240 regels in de delen
