...
par. 10 draait één aanname om die vaak fout gaat: van <!--getal:idem.routesMetRol-->4180<!--/getal--> routes met een rol
zijn er <!--getal:idem.beoordeeld-->1666<!--/getal--> beproefd op herhaalbaarheid en <!--getal:idem.ongemeten-->3247<!--/getal--> ongemeten (`IDEMPROEF.json`,
...
staat er met de meting erbij: van de <!--getal:idem.beoordeeld-->1666<!--/getal--> beproefde muterende routes zijn er
<!--getal:idem.beschermd-->1665<!--/getal--> retry-veilig, en een schemaregister (`payment.authorized.v1` met een vorm
...
schrijft ze tussen merktekens uit de registers (`<!--getal:idem.ongemeten-->3247<!--/getal--> randen,
