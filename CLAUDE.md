...
par. 10 draait één aanname om die vaak fout gaat: van <!--getal:idem.routesMetRol-->3815<!--/getal--> routes met een rol
zijn er <!--getal:idem.beoordeeld-->1617<!--/getal--> beproefd op herhaalbaarheid en <!--getal:idem.ongemeten-->3038<!--/getal--> ongemeten (`IDEMPROEF.json`,
...
staat er met de meting erbij: van de <!--getal:idem.beoordeeld-->1617<!--/getal--> beproefde muterende routes zijn er
<!--getal:idem.beschermd-->1615<!--/getal--> retry-veilig, en een schemaregister (`payment.authorized.v1` met een vorm
