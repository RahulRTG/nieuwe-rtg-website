...
| Ruggengraat | **<!--getal:codewereld.ruggengraat-->5490<!--/getal--> van <!--getal:codewereld.paden-->6288<!--/getal--> paden (<!--getal:codewereld.ruggengraatPct-->87.3<!--/getal-->%) staan in meer dan één register** |
| Brug route → bestand | <!--getal:codewereld.brugPaden-->5365<!--/getal--> paden, uit **2** registers |
| Verschillen in die brug | 1, getoetst op <!--getal:codewereld.brugToetsbaar-->5051<!--/getal--> paden (<!--getal:codewereld.brugDekkingPct-->94.1<!--/getal-->%) — soort: zie §0.3 |
| Bronbereik **structuur** | <!--getal:codewereld.bronGenoemd-->4325<!--/getal--> van <!--getal:codewereld.bronBestanden-->4675<!--/getal--> (<!--getal:codewereld.bronPct-->92.5<!--/getal-->%) — welke functies er wonen, wie ervan afhangt |
| Bronbereik **gedrag** | **<!--getal:codewereld.bronGedrag-->2404<!--/getal--> van 3987 (<!--getal:codewereld.bronGedragPct-->51.4<!--/getal-->%)** — schrijft het, is het bewezen, is het herhaalbaar |
| — gedrag in `server/` | <!--getal:codewereld.bronServerPct-->58.7<!--/getal-->% |
| — gedrag in `public/` | <!--getal:codewereld.bronPublicPct-->27.5<!--/getal-->% |
...
sinds 3 september (§0.3) en de dekking staat nu op <!--getal:codewereld.brugDekkingPct-->94.1<!--/getal-->%.

**De belofte "80–95% zonder bron te beantwoorden" haalt vandaag <!--getal:codewereld.bronGedragPct-->51.4<!--/getal-->%** —
...
`server/` haalt <!--getal:codewereld.bronServerPct-->58.7<!--/getal-->%, `public/` <!--getal:codewereld.bronPublicPct-->27.5<!--/getal-->%. Dat tweede was **6,6%** tot
...
**<!--getal:symbolen.gelezen-->4366<!--/getal--> bestanden gelezen, <!--getal:symbolen.totaal-->22665<!--/getal--> benoemde symbolen met een regelnummer,
<!--getal:symbolen.kanten-->5742<!--/getal--> require-kanten** — heen (waar hang ik van af) én terug (wie hangt van
...
onwaar voor <!--getal:symbolen.uitvoerZonderNamen-->2093<!--/getal--> bestanden hier. Het register draagt daarom de vórm
...
<!--getal:codewereld.bronPublicPct-->27.5<!--/getal-->% voor `public/`; wat er wél bij kwam heeft sinds §0.4 een
eigen teller.
...
rondes teruggebracht tot <!--getal:schermroutes.dood-->27<!--/getal--> — en elke ronde is een regel die elders net zo
geldt:
...
route af**. <!--getal:graaf.kanten-->26489<!--/getal--> kanten, <!--getal:graaf.aanroepers-->9699<!--/getal--> symbolen waarvan bekend is wie ze
aanroept, en <!--getal:graaf.routesMetSymbool-->3137<!--/getal--> routes met minstens één afgehandeld symbool.
...
Van de <!--getal:graaf.aanroepen-->149652<!--/getal--> aanroepen is <!--getal:graaf.opgelostPct-->25.8<!--/getal-->% naar een symbool te herleiden (18,1%
...
| contextobject | <!--getal:graaf.contextobject-->15706<!--/getal--> | `k.instantMutate()` — zie hieronder (was 20.961 vóór §0.7) |
...
| **overig** | **<!--getal:graaf.overig-->402<!--/getal-->** | de echte restbak: 2,3% van alle aanroepen |
...
Wat na die vier overblijft is <!--getal:graaf.doelOnbekend-->1<!--/getal-->. Dat is hier geen lege controle: <!--getal:graaf.kanten-->26489<!--/getal-->
...
|---|---|---|
| structuur | dit bestand bestaat, en dit woont erin | <!--getal:codewereld.bronPct-->92.5<!--/getal-->% |
| relatie | waar hangt het mee samen, welk scherm gebruikt het | <!--getal:codewereld.relatie-->4151<!--/getal--> bestanden |
| **gedrag** | schrijft het, klopt het, is het bewezen | **<!--getal:codewereld.bronGedragPct-->51.4<!--/getal-->%** |
...
doen (<!--getal:codewereld.bronPublicPct-->27.5<!--/getal-->% — daarvóór 6,6%). `scripts/schermgedrag.js` →
...
aftrek op <!--getal:codewereld.bronPublicPct-->27.5<!--/getal-->%. Dat verschil van vijf punten is precies het deel waarover
...
<!--getal:kern.namen-->1246<!--/getal--> namen met een herkomst, over <!--getal:kern.vulplekken-->300<!--/getal--> vulplekken, met
<!--getal:kern.onopgelost-->29<!--/getal--> plekken die niet te volgen zijn — elk met een reden, geen daarvan geraden.
...
| | vóór §0.7 | na |
|---|---|---|
| aanroepkanten | 17.596 | <!--getal:graaf.kanten-->26489<!--/getal--> |
| aanroepen herleid | 18,1% | <!--getal:graaf.opgelostPct-->25.8<!--/getal-->% |
| routes met een symbool | 2346 | <!--getal:graaf.routesMetSymbool-->3137<!--/getal--> |
| post `contextobject` | 20.961 | <!--getal:graaf.contextobject-->15706<!--/getal--> |

<!--getal:graaf.viaKern-->5885<!--/getal--> kanten bestaan puur dankzij deze herkomst. Van die kanten wijzen er
<!--getal:graaf.viaKernZonderSymbool-->4079<!--/getal--> alleen het **bestand** aan en niet de functie, en dat is geen slordigheid
...
Nog niet alles is los: een deel van de aanroepen blijft staan in vormen die dit
register niet aanwijst. Die tellen gewoon door in de post `contextobject` — en
dat is beter dan ze met een aanname te vullen.

#### Een tweede ronde, en een fout die de verbetering zelf maakte

De eerste versie hierboven leverde meteen twee problemen op, allebei van de soort
"een register dat iets beweert wat het niet weet":

**Een lokale variabele die toevallig `kern` heet.** De regel voor het
basisobject was *elke* `const kern = { … }`, en `server/kern/command/journaal.js`
bouwt zo'n object voor iets heel anders. Namen als `id` en `herkomst` kregen
daardoor een tweede, verzonnen oorsprong. De zak wordt op ÉÉN plek gemaakt
(`server/server.js`) en op veel plekken uitgebreid; alleen die ene plek telt nu
als basisobject.

**Doorgeven is geen herkomst.** `maakMobiliteit(state)` doet
`const { db, save } = state` en geeft die via een gedeelde context weer terug.
Zonder tegenmaatregel heet mobiliteit dan de herkomst van `kern.db`. Een naam
telt daarom alleen als zijn **waarde** daar ontstaat, niet als hij er doorheen
reist. Het resultaat van die regel is scherp: het aantal namen met méér dan één
herkomst ging van 16 naar **0** — alle dubbelingen waren doorgeefposten.

### 0.8 De restbak doorgelopen (3 september 2026)

Na §0.7 stond er dat de restbak van de aanroepgraaf — <!--getal:graaf.overig-->402<!--/getal--> aanroepen — "klein
genoeg is om met de hand door te lopen, en groot genoeg om er iets in te vinden".
Dat is gedaan. Hij begon op **3071** en staat nu op <!--getal:graaf.overig-->402<!--/getal--> (0,27% van alle
aanroepen).

Er zat geen enkel raadsel in. Wat erin zat waren **vijf bekende vormen die de
meter niet herkende**, en dat is iets anders: een restbak vol bekende vormen laat
je denken dat je code ondoorgrondelijk is, terwijl je meter gewoon te weinig
weet.

| vorm | voorbeeld | wat het nu is |
|---|---|---|
| module van buiten | `path.join()`, `fs.readFileSync()` | soort `externeModule` (<!--getal:graaf.externeModule-->815<!--/getal-->) |
| eigen zak van een domein | `const { H, heleCenten } = horeca` | soort `uitgepaktObject` (<!--getal:graaf.uitgepaktObject-->1506<!--/getal-->) |
| module die zelf een functie is | `const rem = require('../rem'); rem({…})` | **kant** naar dat bestand (<!--getal:graaf.moduleAlsFunctie-->82<!--/getal-->) |
| methode op iets ingevoerds | `const { log } = require('../log'); log.warn()` | **kant** naar dat bestand (<!--getal:graaf.lidOpInvoer-->260<!--/getal-->) |
| uitgepakt uit een fabriek | `const { publiek } = require('./beeld')({…})` | **kant** naar dat bestand (<!--getal:graaf.uitFabriek-->213<!--/getal-->) |
...
wél dezelfde vórm als het contextobject maar niet de kern — die twee door elkaar
halen zou de post `contextobject` laten groeien met iets waar
`KERNHERKOMST.json` per definitie niets over kan zeggen.

**Eén bijna-bevinding, en waarom het er geen is.** `publiek(…)` wordt in
`kern/muziek-uitgave.js` op vijf plaatsen aangeroepen en staat pas op regel 187
in het bestand — ná al die aanroepen. Dat ziet eruit als een ReferenceError, en
het is het niet: die regels staan in functies die pas draaien nadat de fabriek is
uitgevoerd. Het was geen bug maar een patroon dat de meter niet volgde, en na het
volgen ervan verdwenen 21 aanroepen uit de restbak. Zo'n geval hoort nagetrokken
te worden vóór het "vondst" heet.

En één fout van de verbetering zelf: de nieuwe kanten wijzen bewust alleen een
...
Eindstand van de graaf na §0.7 en §0.8: <!--getal:graaf.kanten-->26489<!--/getal--> kanten,
<!--getal:graaf.opgelostPct-->25.8<!--/getal-->% herleid, <!--getal:graaf.routesMetSymbool-->3137<!--/getal--> routes met een symbool.
...
toelichting als een echte import van dát bestand, en meldt hem als kapot pad —
één keer in `scripts/kernherkomst.js`, één keer in `scripts/aanroepgraaf.js`. De
keuring heeft gelijk: zij kan niet zien dat het een voorbeeld is, en een
...
Na §0.8 stond er dat gedrag (<!--getal:codewereld.bronGedragPct-->51.4<!--/getal-->%) alleen omhoog gaat met méér bewijs,
...
1. **De brug route → bestand heeft een tweede bron** (`ROUTEBRON.json`):
   <!--getal:codewereld.brugDekkingPct-->94.1<!--/getal-->% toetsbaar in plaats van 0,7%, met <!--getal:routebron.tegenspraak-->0<!--/getal--> echte tegenspraken.
2. **`public/` heeft gedragsdekking** (`SCHERMROUTES.json`): <!--getal:codewereld.bronPublicPct-->27.5<!--/getal-->% in plaats
...
het is niet de graaf: **over gedrag weet dit huis <!--getal:codewereld.bronGedragPct-->51.4<!--/getal-->%** — structuur
...
1. ~~**Gedragsdekking van `public/`**~~ — gedaan in §0.5: 6,6% → <!--getal:codewereld.bronPublicPct-->27.5<!--/getal-->%.
...
2. ~~**De <!--getal:graaf.contextobject-->15706<!--/getal--> contextobject-aanroepen via een runtime-meting**~~ — gemeten in
...
3. ~~**`kern.save` terugvoeren naar de module die hem erin zette**~~ — gedaan in
   ...
   <!--getal:graaf.viaKern-->5885<!--/getal--> nieuwe kanten, en de graaf van 18,1% naar <!--getal:graaf.opgelostPct-->25.8<!--/getal-->%.
...
- **De gedragsteller staat op <!--getal:codewereld.bronGedragPct-->51.4<!--/getal-->%** en dat is nog steeds het enige getal dat
...
- **De restbak van de aanroepgraaf** is nu <!--getal:graaf.overig-->402<!--/getal--> aanroepen (2,3%). Dat is klein
...
- De meetronde van §0.3 vond <!--getal:schermroutes.dood-->27<!--/getal--> dode paden, maar begon op 118. Die van §0.4
