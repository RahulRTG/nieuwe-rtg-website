...
route af**. <!--getal:graaf.kanten-->26516<!--/getal--> kanten, <!--getal:graaf.aanroepers-->9706<!--/getal--> symbolen waarvan bekend is wie ze
aanroept, en <!--getal:graaf.routesMetSymbool-->3131<!--/getal--> routes met minstens één afgehandeld symbool.
...
Van de <!--getal:graaf.aanroepen-->149652<!--/getal--> aanroepen is <!--getal:graaf.opgelostPct-->25.9<!--/getal-->% naar een symbool te herleiden (18,1%
...
| contextobject | <!--getal:graaf.contextobject-->15676<!--/getal--> | `k.instantMutate()` — zie hieronder (was 20.961 vóór §0.7) |
...
Wat na die vier overblijft is <!--getal:graaf.doelOnbekend-->0<!--/getal-->. Dat is hier geen lege controle: <!--getal:graaf.kanten-->26516<!--/getal-->
...
verklaart waarom dat nul een nul mág zijn: **`bewaakteVooruitwijzing`**
(<!--getal:graaf.bewaakteVooruitwijzing-->1<!--/getal-->). Een aanroep naar een integratie die met opzet nog niet gebouwd
is, waarbij het aanroepende bestand ZELF toetst of de functie bestaat en anders
met een genoemde fout afbreekt. `server/accounts/transactie.js` vraagt op regel
102 of `verzoekcontext.registreerDeelnemer` een functie is en gooit anders
`PG_ACCOUNTS_DEELNEMER_ONTBREEKT`; regel 128 is daarmee onbereikbaar tot de
PostgreSQL-accountketen bestaat. Dat is een gedeclareerd gat en geen vergissing —
de twee gevallen die de meter tot dan kende ("de invoer klopt niet meer", "het
symbool is hernoemd") pasten er allebei niet op.

Twee dingen horen daarbij, en ze zijn belangrijker dan de teller zelf. **Het was
twee weken onzichtbaar**: de code kwam op 6 september, het register was van 3
september, en niemand mat ertussen — hetzelfde patroon als de 27 "dode paden"
hierboven. En **de bak naast een ratel is een vluchtheuvel als niemand hem
controleert**: alles wat erin belandt telt niet meer mee in `doelOnbekend`.
`test/codewereld.test.js` toets 6a rekent daarom elke regel na tegen de echte
bron — de wacht moet op dezelfde naam staan, in hetzelfde bestand, en werkelijk
afbreken. Een wacht die alleen waarschuwt is geen wacht; dat is met een mutatie
nagetrokken, en de aanroep valt dan gewoon terug in `doelOnbekend`.
...
| | vóór §0.7 | na |
|---|---|---|
| aanroepkanten | 17.596 | <!--getal:graaf.kanten-->26516<!--/getal--> |
| aanroepen herleid | 18,1% | <!--getal:graaf.opgelostPct-->25.9<!--/getal-->% |
| routes met een symbool | 2346 | <!--getal:graaf.routesMetSymbool-->3131<!--/getal--> |
| post `contextobject` | 20.961 | <!--getal:graaf.contextobject-->15676<!--/getal--> |

<!--getal:graaf.viaKern-->5912<!--/getal--> kanten bestaan puur dankzij deze herkomst. Van die kanten wijzen er
<!--getal:graaf.viaKernZonderSymbool-->4105<!--/getal--> alleen het **bestand** aan en niet de functie, en dat is geen slordigheid
...
Eindstand van de graaf na §0.7 en §0.8: <!--getal:graaf.kanten-->26516<!--/getal--> kanten,
<!--getal:graaf.opgelostPct-->25.9<!--/getal-->% herleid, <!--getal:graaf.routesMetSymbool-->3131<!--/getal--> routes met een symbool.
...
3. ~~**`kern.save` terugvoeren naar de module die hem erin zette**~~ — gedaan in
   ...
   <!--getal:graaf.viaKern-->5912<!--/getal--> nieuwe kanten, en de graaf van 18,1% naar <!--getal:graaf.opgelostPct-->25.9<!--/getal-->%.
