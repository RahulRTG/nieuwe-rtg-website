...
| As | Getal | Graad |
|---|---|---|
| kantoorroutes (`/api/office` + `/api/boardroom`) | **<!--getal:kantoor.routes-->607<!--/getal-->** over <!--getal:kantoor.bestanden-->97<!--/getal--> bestanden | gemeten |
| deur eist een bewezen mens | **<!--getal:kantoor.deurEistMens-->179<!--/getal-->** | gemeten |
| deur is de gedeelde code | **<!--getal:kantoor.deurGedeeld-->428<!--/getal-->** | gemeten |
| handler kent de handelende mens | <!--getal:kantoor.handlerKentMens-->141<!--/getal--> | vermoed (bovengrens) |
| **anoniem uitvoerbaar** | **<!--getal:kantoor.anoniem-->366<!--/getal-->** | vermoed (ondergrens) |
...
niet. De <!--getal:kantoor.anoniem-->366<!--/getal--> anonieme routes blijven anoniem van een nieuwe schil.
...
**`ENFORCE_EXECUTE` heeft een prijs.** <!--getal:kantoor.deurGedeeld-->428<!--/getal--> routes hangen aan de gedeelde deur, en
