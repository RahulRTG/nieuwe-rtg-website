...
| As | Getal | Graad |
|---|---|---|
| kantoorroutes (`/api/office` + `/api/boardroom`) | **<!--getal:kantoor.routes-->614<!--/getal-->** over <!--getal:kantoor.bestanden-->99<!--/getal--> bestanden | gemeten |
| deur eist een bewezen mens | **<!--getal:kantoor.deurEistMens-->189<!--/getal-->** | gemeten |
