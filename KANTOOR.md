...
| As | Getal | Graad |
|---|---|---|
| kantoorroutes (`/api/office` + `/api/boardroom`) | **<!--getal:kantoor.routes-->616<!--/getal-->** over <!--getal:kantoor.bestanden-->100<!--/getal--> bestanden | gemeten |
| deur eist een bewezen mens | **<!--getal:kantoor.deurEistMens-->191<!--/getal-->** | gemeten |
