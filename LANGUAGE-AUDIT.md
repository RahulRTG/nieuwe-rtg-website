...
- Een bediening werd gevonden via de Nederlandse waarde van `aria-label`. De gedeelde Edge-projectie gebruikt daarvoor nu de bestaande structurele navigatieklasse. Vertaalde tekst bepaalt niet welke bediening wordt aangesloten.
