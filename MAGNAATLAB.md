...
```
64 simulatiemodules tegenover 1397 kernmodules in 409 domeinen
   magnaat        61 modules
   hospitality     3 modules

1. HET BEREIK
   113 requires in de simulatielaag
     1 kernmodule geraakt, in 1 van 409 domeinen        (0%)
...
Vandaag is dat 0% van 409 domeinen. Dat getal is de opgave, en het is ook de
