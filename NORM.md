...
- 2511 API-routes, waarvan 1495 (60%) bij naam in een test voorkomen
- de overige 1016 worden door `test/grens-sweep.test.js` wel echt aangeroepen,
  met vier harde eisen -- dat is een vloer, geen vervanging
- 0 stuk, 0 scheef, 127 "kan beter" in de keuring
- 0 externe pakketten
- 407 testbestanden

Het cijfer van 60% telt de sweep bewust NIET mee. Zou dat wel gebeuren, dan
sprong de teller naar 100% terwijl er niets diepgaands getoetst was, en was het
cijfer niets meer waard. De teller hoort te blijven wijzen waar de echte tests
nog moeten komen.
