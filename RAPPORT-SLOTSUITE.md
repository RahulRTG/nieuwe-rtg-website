...
_Automatisch geschreven door `scripts/slotsuite.js` op 2026-07-28 11:43 UTC. Niet met de hand bijwerken:
...
| DE KEURING | staat | 12.7 s | 0 stuk, 1 scheef, 126 kan beter |

## Het logica-oordeel

- endpoints die in een test voorkomen: **1285 van 2489** (52%)
- genres op pariteit bekeken: **43**
- teksten gescand op beloftes: **1676** bestanden, 2 zin(nen) eerder gewogen en goedgekeurd
- oordeel: **0 stuk, 1 scheef, 126 kan beter**
...
1. **[SCHEEF / dekking]** Minder dan zestig procent van de endpoints komt in een test voor (52%).
   - aanpak: Elke ronde een paar endpoints erbij is genoeg; begin bij de lijst hieronder.
2. **[BETER / dekking]** Het domein "supplier" heeft 265 endpoint(s) zonder test.
...
3. **[BETER / dekking]** Het domein "member" heeft 170 endpoint(s) zonder test.
   ...
   - aanpak: Neem er de volgende ronde twee of drie mee in een bestaande testfile.
4. **[BETER / dekking]** Het domein "foundation" heeft 166 endpoint(s) zonder test.
   ...
   - aanpak: Neem er de volgende ronde twee of drie mee in een bestaande testfile.
5. **[BETER / dekking]** Het domein "rtf" heeft 113 endpoint(s) zonder test.
   - waar: `/api/rtf/apply/chat, /api/rtf/apply/chat/send, /api/rtf/baby/boek, /api/rtf/baby/entry-weg, /api/rtf/baby/favoriet`
   - aanpak: Neem er de volgende ronde twee of drie mee in een bestaande testfile.
6. **[BETER / dekking]** Het domein "office" heeft 95 endpoint(s) zonder test.
   ...
   - aanpak: Neem er de volgende ronde twee of drie mee in een bestaande testfile.
7. **[BETER / dekking]** Het domein "werkplek" heeft 66 endpoint(s) zonder test.
   ...
   - aanpak: Neem er de volgende ronde twee of drie mee in een bestaande testfile.
8. **[BETER / dekking]** Het domein "bank" heeft 30 endpoint(s) zonder test.
   - waar: `/api/bank/advies, /api/bank/akkoord, /api/bank/bevries, /api/bank/bulk, /api/bank/hart`
   - aanpak: Neem er de volgende ronde twee of drie mee in een bestaande testfile.
9. **[BETER / dekking]** Het domein "genootschap" heeft 28 endpoint(s) zonder test.
   ...
   - aanpak: Neem er de volgende ronde twee of drie mee in een bestaande testfile.
10. **[BETER / omvang]** Dit bestand zit met 10013 bytes vlak onder de grens van 10.240.
   - waar: `server/db/geheugen.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
11. **[BETER / omvang]** Dit bestand zit met 9636 bytes vlak onder de grens van 10.240.
   - waar: `server/db/gidsen.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
12. **[BETER / omvang]** Dit bestand zit met 10065 bytes vlak onder de grens van 10.240.
   - waar: `server/foundation/gasten/gezinsleven.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
13. **[BETER / omvang]** Dit bestand zit met 9665 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/agenda-pro.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
14. **[BETER / omvang]** Dit bestand zit met 10090 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/antivirus/index.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
15. **[BETER / omvang]** Dit bestand zit met 10233 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/appgids-data/deel3.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
16. **[BETER / omvang]** Dit bestand zit met 9948 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/appgids-data/deel6.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
17. **[BETER / omvang]** Dit bestand zit met 9559 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/assets/winkel.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
18. **[BETER / omvang]** Dit bestand zit met 9859 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/autoverkoop/deal.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
19. **[BETER / omvang]** Dit bestand zit met 9462 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/baby.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
20. **[BETER / omvang]** Dit bestand zit met 9516 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/bank/overboeken.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
21. **[BETER / omvang]** Dit bestand zit met 10009 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/creator.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
22. **[BETER / omvang]** Dit bestand zit met 9987 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/directpay/index.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
23. **[BETER / omvang]** Dit bestand zit met 9446 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/eenaccount.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
24. **[BETER / omvang]** Dit bestand zit met 9439 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/factuur.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
25. **[BETER / omvang]** Dit bestand zit met 10189 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/fluister/seintjes.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
26. **[BETER / omvang]** Dit bestand zit met 9734 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/gebouw.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
27. **[BETER / omvang]** Dit bestand zit met 9472 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/geloofbieb-kern/deel2.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
28. **[BETER / omvang]** Dit bestand zit met 9755 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/genootschap/index.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
29. **[BETER / omvang]** Dit bestand zit met 9642 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/groothandel/orderlaag.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
30. **[BETER / omvang]** Dit bestand zit met 9471 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/koppel.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
31. **[BETER / omvang]** Dit bestand zit met 10092 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/lid.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
32. **[BETER / omvang]** Dit bestand zit met 9615 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/luchthaven/index.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
33. **[BETER / omvang]** Dit bestand zit met 10033 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/marechaussee.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
34. **[BETER / omvang]** Dit bestand zit met 10103 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/markt.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
35. **[BETER / omvang]** Dit bestand zit met 10087 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/muziek-uitgave.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
36. **[BETER / omvang]** Dit bestand zit met 9730 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/ontmoeting/date.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
37. **[BETER / omvang]** Dit bestand zit met 9717 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/overheid/rechtbank.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
38. **[BETER / omvang]** Dit bestand zit met 9632 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/pay/index.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
39. **[BETER / omvang]** Dit bestand zit met 9541 bytes vlak onder de grens van 10.240.
   - waar: `server/kern/rtgonderzoeker.js`
   - aanpak: Knip er een deelbestand af zolang het rustig kan.
40. **[BETER / omvang]** Dit bestand zit met 9510 bytes vlak onder de grens van 10.240.
