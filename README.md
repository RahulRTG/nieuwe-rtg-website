...
Getoetst in `test/rtfos.test.js` (twaalf scenario's op de grendels) en `test/rtfosschermen.e2e.js` (de twee schermen, inclusief het rauwe antwoord aan de gemeente). De 30%-afdracht van RTG naar de stichting blijft waar hij stond (`kern/fonds.js`); dit OS gaat over wat de stichting met dat geld dóét.
