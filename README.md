...
`test/webplatform.test.js` (tien scenario's) legt dit vast; zeven mutaties (leden mogen zelf een zaakCode zetten; de live blokken worden niet meer opgelost; het formulier accepteert sites zonder ontvanger; de etalage-grendel valt weg; het oplossen slaat de extra pagina's over; de AI-demostand zegt "gedaan" zonder daad; het formulier bereikt ook niet-verbonden leden), alle zeven **RAAK**.
