...
| 4.9 | **90 van de 188 apps hebben geen eigen schermtoets** (was 104). `scripts/schermen.js` telt de apps waar geen enkele toets de weg werkelijk aflegt: nooit geopend, of alleen aangetikt door een veegtoets. Deze ronde zijn er veertien bij gekomen, precies aan de risicokant: de twaalf Lifestyle-apps (`test/lifestyleschermen.e2e.js`, in twee standen -- de poort zonder pas en de eigen gegevens met pas) en RTG iD, passkeys en Balans (`test/identiteitschermen.e2e.js`). Daarmee is ook het schermgat gesloten dat bij 6.3 was genoteerd | het getal daalt gestaag; begin bij de apps waar geld, toegang of identiteit langskomt. Let op: tien kantoor-apps zijn pas te toetsen als 5.5 is opgelost -- die sturen uitgelogd weg naar `personeel.html` in plaats van hun eigen deur te tonen, dus een schermtoets landt daar op de verkeerde pagina |
