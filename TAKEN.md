...
| 4.9 | **48 van de 188 apps hebben geen eigen schermtoets** (was 104 aan het begin van deze reeks). `scripts/schermen.js` telt de apps waar geen enkele toets de weg werkelijk aflegt. Toegevoegd: de twaalf Lifestyle-apps in twee standen, RTG iD/passkeys/Balans, de acht kantoor-apps (na 5.5), de vier juridische pagina's, acht RTF-kinderschermen, acht overheidsschermen (`overheidschermen.e2e.js`) en zestien reis- en uitgaansschermen (`reisschermen.e2e.js`). Negen schermen kwamen erbij zonder nieuwe toets: mijn eigen schermtoetsen lieten de service worker tientallen schermen vooruit ophalen, waardoor er een als VEEGTOETS telde en zijn eigen werk niet meetelde | het getal daalt gestaag; begin bij de apps waar geld, toegang of identiteit langskomt |
