...
(function(w,d){
  ...
  function groei(pas,plan,vakken){
    ...
    else vak.innerHTML=vakken.slice(0,6).map(function(v){var n=(v.doelen||[]).length,k=(v.doelen||[]).filter(function(x){return x.behaald}).length,p=n?Math.round(k/n*100):0;return '<a class="lg-vak" href="leerpaspoort.html"><i class="lg-vak__icoon" data-glyf="diploma"></i><div><b>'+esc(v.vak)+'</b><span>'+k+' van '+n+' leerdoelen hebben bewijs</span><div class="lg-meter" aria-hidden="true"><i style="width:'+p+'%"></i></div></div><em aria-hidden="true">&rarr;</em></a>'}).join('');
