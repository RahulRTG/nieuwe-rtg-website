...
(function (w) {
  ...
  function toegangSlot(reden, laden) {
    ...
    el.innerHTML = '<div style="width:min(92vw,34rem);padding:1.35rem;border:1px solid #3a3730;border-radius:18px;background:#151513;box-shadow:0 24px 80px rgba(0,0,0,.55)">' +
      ...
      '<h1 style="font:500 1.75rem/1.15 Georgia,serif;margin:0.5rem 0">' + (laden ? 'Jouw passen worden gecontroleerd…' : 'Deze ruimte blijft nog dicht') + '</h1>' +
      '<p style="color:#bdb8ad;line-height:1.55;margin:0 0 1.25rem">' + esc(reden || 'De server controleert je leeftijd en passen voordat dit scherm opengaat.') + '</p>' +
