...
(function () {
  ...
  function teken(w, plan, blik, ctx) {
    ...
    h += plan.taken.map(function (t2) {
      ...
      return '<div style="display:flex;align-items:center;gap:0.55rem;border:1px solid var(--line);border-radius:12px;padding:0.45rem 0.6rem;margin-top:0.5rem;' + (t2.klaar ? 'opacity:0.45;' : '') + '">' +
