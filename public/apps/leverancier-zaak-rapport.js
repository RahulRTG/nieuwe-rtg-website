...
(function(){
  ...
  function open(ctx){
    ...
    const html3 = '<!doctype html><html lang="' + (en3 ? 'en' : 'nl') + '"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">' +
      ...
      '.kpi{border:1px solid var(--line);border-radius:0;padding:.7rem .85rem;}.kpi b{display:block;font-family:"Bodoni Moda",serif;font-weight:500;font-size:1.3rem;color:var(--gold);}' +
      ...
      '.staaf i{display:block;width:100%;max-width:36px;margin:0 auto;background:var(--gold);border-radius:0;-webkit-print-color-adjust:exact;print-color-adjust:exact;}' +
