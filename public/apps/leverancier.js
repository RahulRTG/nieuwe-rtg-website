...
/* DIT SLUITHAAKJE HOORT HIER, EN NIET EEN BESTAND VERDEROP.
  ...
  function renderVerhuur(){
    ...
    html += '<div class="card"><div class="tt-h">'+T('vh.vloot','Vloot')+' ('+autos.filter(a=>a.actief!==false).length+')</div>'+
      ...
      (canEdit ? '<details class="h-mt100"><summary style="cursor:pointer;font-size:0.82rem;color:var(--gold);">'+T('vh.f.nieuw','Auto toevoegen')+'</summary><div style="margin-top:0.8rem;">'+
  ...
  function renderCharter(){
    ...
    html += '<div class="card"><div class="tt-h">'+T('ch.vloot','Vloot')+' ('+boten.filter(b=>b.actief!==false).length+')</div>'+
      ...
      (canEdit ? '<details class="h-mt100"><summary style="cursor:pointer;font-size:0.82rem;color:var(--gold);">'+T('ch.f.nieuw','Vaartuig toevoegen')+'</summary><div style="margin-top:0.8rem;">'+
  ...
  function renderBeheer(){
    ...
    el.innerHTML = '<div class="card">'+
      ...
      '<div class="card"><div class="tt-h">Magnaat Partnerstudio</div><div style="margin-top:0.4rem;font-size:0.78rem;color:var(--muted);line-height:1.6;">Bouw een veilige digitale tweeling van uw echte bedrijf en train personeel zonder echt geld, klantdata of productieacties.</div><div style="margin-top:0.7rem;"><a class="obtn primary" href="/apps/magnaat-partnerstudio.html">Open Partnerstudio</a></div></div>'+
