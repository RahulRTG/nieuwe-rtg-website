...
(function () {
  ...
  function teken(s, h) {
    ...
    q('#vnWereld').innerHTML = '<div class="eyebrow">Je stad</div><h3>' + esc(s.wereld.stad) + '</h3>' +
      ...
      '<div id="vnVerhaal"></div><div id="vnMarkt"></div><h3>Spelregels van ' + esc(s.wereld.stad) + '</h3><ul class="vn-waarom">' + (s.wereld.spelregels || []).map(function (r) { return '<li>' + esc(r) + '</li>'; }).join('') + '</ul>' +
