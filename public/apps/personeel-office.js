...
(function () {
  ...
  function teken() {
    ...
    el.id = 'pdOffice';
    el.innerHTML = '<div style="border:1px solid var(--line,rgba(255,255,255,0.1));border-radius:14px;padding:0.8rem 0.95rem;margin-top:0.75rem;">' +
      '<div style="font-size:0.62rem;letter-spacing:0.14em;text-transform:uppercase;color:var(--gold,#A98F1C);">RTG Office</div>' +
      '<div style="font-size:0.72rem;color:var(--soft,rgba(255,255,255,0.55));margin-top:0.25rem;">De team-drive van de zaak: documenten, rekenbladen, presentaties, formulieren, schetsen en borden.</div>' +
      '<button id="pdOfficeOpen" type="button" style="margin-top:0.5rem;width:100%;padding:0.55rem 0.7rem;border-radius:10px;border:1px solid var(--line,rgba(255,255,255,0.1));background:none;color:inherit;font:inherit;font-size:0.8rem;cursor:pointer;">Office openen &rarr;</button></div>';
