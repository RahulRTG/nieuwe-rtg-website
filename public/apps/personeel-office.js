...
(function () {
  ...
  function teken() {
    ...
    el.id = 'pdOffice';
    el.innerHTML = '<div style="border:1px solid var(--line,rgba(255,255,255,0.1));border-radius:14px;padding:0.8rem 0.95rem;margin-top:0.8rem;">' +
      ...
      '<button id="pdOfficeOpen" type="button" style="margin-top:0.55rem;width:100%;padding:0.55rem 0.7rem;border-radius:10px;border:1px solid var(--line,rgba(255,255,255,0.1));background:none;color:inherit;font:inherit;font-size:0.8rem;cursor:pointer;">Office openen &rarr;</button></div>';
