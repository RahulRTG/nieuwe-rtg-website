...
/* Personeel, deel 3b: het oude inlogFORMULIER, nog als vangnet.
  ...
  function toonKantoorLogin(){
    $('#gateStep').innerHTML = '<button class="gback" id="kaTerug">← '+T('pd.back','Terug')+'</button>'+
      ...
      '<div class="pinrow rtg-duimeind" style="margin-top:0.6rem;"><input id="kaCode" type="password" autocomplete="current-password" style="letter-spacing:0.1em;" placeholder="&bull;&bull;&bull;&bull;">'+
