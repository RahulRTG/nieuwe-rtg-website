...
(function(w,d){
  ...
  w.RTGCommandWerktafel=function(o){
    var root=null,panes=[],actief=-1,consoleLaag=null,HOOFDAPPS=o.catalog.HOOFDAPPS,INSTELLINGEN=o.catalog.INSTELLINGEN,titelVan=o.catalog.titelVan;
    ...
    /* zet() is de enige ingang voor de stand. Wisselt hij, dan wordt opnieuw
       ...
       (inloggen versus openen) en het gesprek verhuist mee. In de open stand
    ...
    return{zet:zet,toon:toon,sluitAlles:sluitAlles,openNaast:openNaast,sluit:sluit,select:select,sync:sync,sloop:sloop,wis:wis,stand:function(){return stand},
