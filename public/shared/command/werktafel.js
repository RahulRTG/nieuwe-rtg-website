...
(function(w,d){
  ...
  w.RTGCommandWerktafel=function(o){
    ...
    return{zet:zet,toon:toon,sluitAlles:sluitAlles,openNaast:openNaast,sluit:sluit,select:select,sync:sync,sloop:sloop,wis:wis,werelden:werelden,stand:function(){return stand},
