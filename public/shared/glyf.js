...
(function () {
  ...
  var P = {
    ...
    /* --- bedrijfscategorieen (app-bibliotheek, sectoren) --- */
    ontwerp: '<path d="M5 5v14h14z"/><path d="M5 11h7M5 15h4"/>',
    film: '<path d="M3.5 9.2h17v8.3a1.5 1.5 0 0 1-1.5 1.5H5a1.5 1.5 0 0 1-1.5-1.5z"/><path d="M3.8 9.2l1.5-3 3 .8-1.5 3M8.3 6.9l3 .8-1.5 3M13.3 7.9l3 .8-1.5 3"/>',
    zorg: '<rect x="4.5" y="4.5" width="15" height="15" rx="3.5"/><path d="M12 8.4v7.2M8.4 12h7.2"/>',
    horeca: '<path d="M7 4v6.5a1.8 1.8 0 0 0 1.8 1.8V20M7 4v4.6M9.4 4v4.6M11.8 4c1.4 0 2.3 1.6 2.3 4.2s-.9 3.8-2.3 3.8h-.4V20"/>',
    logistiek: '<path d="M3.2 7h9.6v8H3.2zM12.8 10h3.6l3.4 3.2V15h-7z"/><circle cx="7" cy="17" r="1.5"/><circle cx="16.4" cy="17" r="1.5"/>',
    agenda: '<rect x="4.5" y="5.5" width="15" height="14" rx="2"/><path d="M4.5 9.6h15M8.4 3.4v4M15.6 3.4v4"/>',
    megafoon: '<path d="M5 10v4h3l1.4 4h2L10 14l8 3.5V6.5L10 10H6a1 1 0 0 0-1 1z"/><path d="M19.5 10a3 3 0 0 1 0 4"/>',
    schild: '<path d="M12 3.4l7 2.5v4.8c0 4.5-3 7.9-7 9.6-4-1.7-7-5.1-7-9.6V5.9z"/>',
    diploma: '<path d="M12 5L3 9l9 4 9-4z"/><path d="M7 11.2V15c0 1.4 2.2 2.6 5 2.6s5-1.2 5-2.6v-3.8M21 9v4.6"/>',
    grafiek: '<path d="M4 20h16"/><path d="M6 18v-5.5M11 18V8M16 18V5.5" stroke-width="2.2"/>',
    oogst: '<path d="M12 20.5V9.2"/><path d="M12 9.2c-2.1 0-3.2-1.6-3.2-3.4 2.1 0 3.2 1.4 3.2 3.4zM12 9.2c2.1 0 3.2-1.6 3.2-3.4-2.1 0-3.2 1.4-3.2 3.4zM12 13.6c-2.1 0-3.2-1.6-3.2-3.4 2.1 0 3.2 1.4 3.2 3.4zM12 13.6c2.1 0 3.2-1.6 3.2-3.4-2.1 0-3.2 1.4-3.2 3.4z"/>',
    bouw: '<path d="M4 16.5a8 8 0 0 1 16 0z"/><path d="M3 16.5h18M9 16.5V9a3 3 0 0 1 6 0v7.5"/>',

    /* --- retail-etages (mall) --- */
    mode: '<path d="M9.2 4h5.6l-1 3.1 4 2.7-2 2.4-1.2-1V20H9.4v-8.8l-1.2 1-2-2.4 4-2.7z"/>',
