...
(function(w){
  ...
  page.querySelector('[data-build-plan]').onclick=function(){
    ...
    context(c);
    zet('[data-twin-state]','PREFLIGHT GESTART');
    zet('[data-flow-evidence]','serverronde');
    zet('[data-live-now]','Context en grenzen direct voorbereid');
    zet('[data-live-next]','Serverbronnen bevestigen');
    zet('[data-live-watch]','0 acties uitgevoerd');
    zet('[data-twin-reason]','De applicatie bereidt direct voor; de server bevestigt bron, gevolg en akkoordgrens.');
