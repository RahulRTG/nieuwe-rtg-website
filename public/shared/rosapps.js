...
(function (w) {
  ...
  w.RTGApps = [
    ...
    { naam: 'Balans',          url: '/apps/geld.html#balans' },
    { naam: 'Wie betaalt wat', url: '/apps/geld.html#wbw' },
    ...
    { naam: 'Mecenaat',        url: '/apps/geld.html#mecenaat' },
    { naam: 'Lab-fonds',       url: '/apps/geld.html#labfonds' },
    { naam: 'RTG-code',        url: '/apps/geld.html#rtgcode' },
    { naam: 'Nalatenschap',    url: '/apps/geld.html#nalatenschap' },
    { naam: 'Logboek',         url: '/apps/geld.html#logboek' },
