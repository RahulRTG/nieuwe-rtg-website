...
(function (w) {
  ...
  var copy = {
    ...
    fileSearch: ['Zoek in uw bestanden', 'Search your files'],
    noteSearch: ['Zoek in uw notities', 'Search your notes'],
    dayView: ['Dag', 'Day'],
    exportAgenda: ['Agenda exporteren', 'Export calendar'],
    planner: ['Plan met Rahul in uw eigen woorden', 'Plan with Rahul in your own words'],
    fileHelp: ['Verwijderde bestanden blijven dertig dagen in de prullenbak en tellen mee voor uw opslagruimte. Als u een bestand deelt op codenaam, kan de ander het bekijken en nieuwe versies toevoegen.', 'Deleted files stay in the bin for thirty days and count towards your storage. If you share a file with a codename, the other person can view it and add new versions.'],
    postNew: ['Plaats een bericht', 'Write a post'],
    following: ['Volgend', 'Following'],
    myProfile: ['Mijn profiel', 'My profile'],
    mySaved: ['Mijn plank', 'My saved posts'],
    postPrompt: ['Wat wilt u delen?', 'What would you like to share?'],
    replyPrompt: ['Schrijf een reactie', 'Write a reply'],
    sendReply: ['Reactie plaatsen', 'Post reply'],
    appreciate: ['Waarderen', 'Appreciate'],
    viewReplies: ['Reacties bekijken', 'View replies'],
    feedEnd: ['U bent weer bij. Dit zijn alle berichten voor nu.', 'You are up to date. These are all the posts for now.'],
    emptyFeed: ['Er staan nog geen berichten van de mensen die u volgt.', 'The people you follow have not posted yet.'],
    emptyDiscover: ['Er zijn nog geen berichten om te ontdekken. U kunt zelf een gesprek beginnen.', 'There are no posts to discover yet. You can start a conversation yourself.'],
