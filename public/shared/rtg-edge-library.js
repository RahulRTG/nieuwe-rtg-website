...
(function (w) {
  ...
  function casco(cfg, s) {
    return '<header class="rtg-edge-top"><a class="rtg-edge-mark" href="' + cfg.home + '" aria-label="Naar ' + cfg.naam + '">RTG</a><nav class="rtg-edge-crumbs" aria-label="U bent hier"></nav><nav class="rtg-edge-worldbar" aria-label="De vier RTG-werelden"></nav><button class="rtg-edge-state" type="button" aria-label="Beveiliging en systeemstatus" aria-expanded="false"><i></i><span>Controleren</span></button></header>' +
      ...
      '<footer class="rtg-edge-bottom"><button class="rtg-edge-menu" type="button" aria-label="Randen en alle functies" aria-expanded="false">' + s('menu') + '<small>MENU</small></button><a href="' + cfg.home + '" aria-label="Naar home">' + s('home') + '<small>HOME</small></a><span class="rtg-edge-history"><button type="button" data-go="back" aria-label="Terug">' + s('back') + '</button><button type="button" data-go="next" aria-label="Vooruit">' + s('next') + '</button></span><button class="rtg-edge-layout" type="button" aria-label="Aantal schermen">' + s('grid') + '<small>1</small></button><div class="rtg-edge-action"><button type="button" data-rtg-edge-primary></button></div><div class="rtg-edge-appslot" aria-label="Functies van dit scherm"></div><button class="rtg-edge-ai" type="button" aria-label="Gesprek met Rahul" aria-expanded="false"><span class="rtg-edge-mouth"></span><small>RAHUL</small></button></footer>';
  }
