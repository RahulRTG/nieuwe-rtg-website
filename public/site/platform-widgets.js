(function(w,d){
 ...
 w.RTGPublicWidgets=function(v){
  ...
  function widget(card){
   ...
   if(card.type==='worlds'){var row=node('div',null,'pp-world-mini');['living','travel','work','foundation'].forEach(function(world){var b=button(null,function(){o.open(company?'worlds':'world:'+world);},'pp-mini-world');b.append(photo('world-homes/'+world));var label=node('span');label.textContent={living:'LivingOS',travel:'TravelOS',work:'WorkOS',foundation:'FoundationOS'}[world];b.append(label);row.append(b);});inside.append(row);}
