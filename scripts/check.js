...
console.log('\n28) elke API-route heeft een poort (of staat met reden op de publieke lijst)');
{
  ...
  /* De lijst met openbare paden woont in ./lib/publiek.js: keuringsregel 28 en
     scripts/handlerwacht.js stellen dezelfde vraag, en twee lijsten van wat
     openbaar mag zijn lopen uiteen (LAT.md regel 4). */
