...
/* De poort hieronder: mag dit register uberhaupt geschreven worden? */
const { eisSchoneBoom } = require('./lib/stempel');
...
/* ==========================================================================
   ...
   Dit bestand schrijft CONTROLS.json, en dat register is geen rapport: de
...
poortVoorSchrijven('het controleregister');
