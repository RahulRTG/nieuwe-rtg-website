...
const GETALLEN = {
  ...
  /* DE EFFECTDEKKING (EXECUTIE.md blok 4). Deze getallen stonden in het document
     overgetypt en waren daardoor verouderd: er stond 96 van 176 terwijl de verse
     meting 87 van 173 zegt. Vandaar levend. */
  'effect.bereikbaar': { bron: 'EFFECTDEKKING.json', veld: 'tellers.bereikbaarPerRol',
    wat: 'handelingen die het AI-stuur mag bedienen (live uit beleid.js)' },
  'effect.onbekend': { bron: 'EFFECTDEKKING.json', veld: 'tellers.onbekendeEffectpaden',
    wat: 'AI-bereikbare handelingen waarvan NIET is gemeten wat zij veroorzaken (moet dalen)' },
  'effect.gemeten': { bron: 'EFFECTDEKKING.json', veld: 'tellers.effectGemeten',
    wat: 'AI-bereikbare handelingen waarvan de proef zag welke collecties veranderen' },
  'effect.geenEffect': { bron: 'EFFECTDEKKING.json', veld: 'tellers.effectGeenEffectGemeten',
    wat: 'AI-bereikbare handelingen waarbij de proef draaide en niets zag veranderen' },
  'effect.contractVolledig': { bron: 'EFFECTDEKKING.json', veld: 'tellers.contractVolledig',
    wat: 'handelingen met een VOLLEDIG effectcontract (mag alleen stijgen)' },
  'effect.contractOnbekend': { bron: 'EFFECTDEKKING.json', veld: 'tellers.contractOnbekend',
    wat: 'AI-bereikbare handelingen zonder enig effectcontract' },
