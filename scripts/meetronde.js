...
/* ============================================================================
   ...
   Draai:  node --experimental-sqlite scripts/meetronde.js
           node --experimental-sqlite scripts/meetronde.js --snel   (alleen 1 en 4)
           node --experimental-sqlite scripts/meetronde.js --alleen=poortwacht
   ========================================================================== */
'use strict';
const fs = require('fs');
...
function draai(cmd, extraEnv) {
  const r = spawnSync(process.execPath, ['--experimental-sqlite'].concat(cmd), {
