...
const KETENS = [
  ...
  { id: 'bestelling-boekhouding', naam: 'Klant -> bestelling -> betaling -> boekhouding', proef: 'OMZETPROEF.json', dekt: 'sluit',
    waar: 'scripts/omzetproef.js -- 7 schakels, 8 storingen, twee echte zaken',
    mist: 'de proef meet de PROJECTIE financeVoor en EEN maand; periodeafsluiting, aangifte en de weg naar een grootboekregel liggen erbuiten' },
