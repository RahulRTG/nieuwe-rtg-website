...
/* DE ZINNEN WAAROP ZE TE HERKENNEN ZIJN, en het zijn er TWEE omdat er twee
   ...
   WAT DAT OVER DE VORM ZEGT, en het staat er liever dan dat het meelift: een
   MARKERCONVENTIE dekt wat iemand eraan heeft gedacht te markeren, en verder
   niets. Elke grendel die morgen met een derde formulering komt, valt hier weer
   buiten. Dat is geen reden om de markers te laten vallen -- een afgeleide lijst
   blijft beter dan een getypte, want die loopt uiteen zodra er een bijkomt --
   maar wel om te weten wat deze poort NIET is: een bewijs dat elke registergrendel
   meedraait. */
const MERKEN = [
