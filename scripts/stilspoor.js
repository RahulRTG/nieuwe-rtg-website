...
'use strict';
/* ============================================================================
   HET SPOOR DAT NIET KAN WEIGEREN -- de handhaver bij LAT.md regel 13.
...
function main() {
  ...
  return {
    ...
    uitleg: 'Schrijfacties waarvan het falen volledig wordt weggevangen, terwijl de aanroeper ' +
      'daarna succes meldt. De klasse van LAT.md regel 13: een belofte over een spoor is pas een ' +
...
function toon(stand) {
  ...
  console.log('\nHET SPOOR DAT NIET KAN WEIGEREN -- LAT.md regel 13\n');
