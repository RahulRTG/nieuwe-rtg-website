...
const BEOORDEELD = new Map([
  ...
  ['reisgezelschap-routes.test.js::leeg.body.leden',
    'na vijf geweigerde uitnodigingen IS de leegte de bewering; dat dezelfde lijst kan vullen staat in de blokken erna (Bram zegt ja en staat erin, some op codenaam)'],
  ['reisgezelschap-routes.test.js::kring.body.meereizen',
