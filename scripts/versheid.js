...
const REGISTERS = [
  ...
  /* DE EFFECTDEKKING (EXECUTIE.md blok 4). Twee assen die nooit worden opgeteld: wat
  ...
  ['EFFECTDEKKING.json', 'npm run effectdekking:vastleggen', 'van hoeveel AI-bedienbare handelingen bekend is wat zij veroorzaken'],
