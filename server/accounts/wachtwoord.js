...
/* De demoseed hasht goedkoper, en waarom dat mag staat in ./demohash.js --
   met de drie grendels eromheen. Hij krijgt het formaat en de parameters van
   hier, zodat er maar EEN plek is die weet hoe een hash eruitziet. */
const { DEMO_N, hashDemoSync } = require('./demohash')({ scryptOpties, schrijfHash, SCRYPT_R, SCRYPT_P });
