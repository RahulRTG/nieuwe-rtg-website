...
// De canonieke vorm van een idempotentiesleutel staat in een eigen module:
// betaal.js en muntbetaal.js gebruiken hem allebei, en een gedeelde waarheid
// hoort op een plek te staan (LAT.md regel 4).
const { canoniekeSleutel } = require('./sleutelvorm');
