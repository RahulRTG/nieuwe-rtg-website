...
module.exports = [
  ...
  { id: 'mediaos', categorie: 'Eigen apps', naam: 'RTG Media (één mediawereld)', standaard: true, doelgroepen: LEDEN,
    ...
    paden: ['/api/mediaos'] },
  { id: 'uitvoering', categorie: 'Eigen apps', naam: 'Uitvoerende media (partituur en aanspraak)', standaard: true, doelgroepen: LEDEN,
    uitleg: 'Een maker publiceert geen bestand maar een partituur: fragmenten, welke daarvan onmisbaar zijn, wat RTG ermee mag doen en wie het mag zien. RTG maakt daar op het moment van vragen \u00e9\u00e9n uitvoering van. Zet u hem uit, dan blijft de mediawereld eronder gewoon werken.',
    paden: ['/api/uitvoering'] },
