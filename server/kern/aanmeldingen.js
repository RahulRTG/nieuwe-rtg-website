...
module.exports = ({ db, save, crypto, schoon, geldPasprijzen }) => {
  ...
  /* Na het menselijke akkoord loopt de betaling automatisch: 12 maanden lang,
     elke maand de maandbijdrage, en van elke termijn gaat 30% naar de RTFoundation
     (20% lokaal, 10% de foundation zelf). Dit is een BETAALSCHEMA (een grootboek
     van 12 geplande termijnen); er wordt nooit geclaimd dat een echte betaling is
     verwerkt -- een betaalprovider zou het schema uitvoeren. */
