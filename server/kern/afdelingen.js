...
module.exports = ({ db, save, crypto, anthropic, ledenAantal }) => {
  ...
  const { taken, taakMaak, taakZet, kamer, kamers, functiesStand, schakel, schakelAlles, schakelGenre, bouwVoorstellen, voorstellen, boardroom, platformStats } = deelBoardroom;
  ...
  return { afdelingen: { kamers, kamer, taakMaak, taakZet, boardroom, schakel, schakelAlles, schakelGenre, voorstellen, paniekStel, paniekBesluit, paniekBericht, paniekLijst, platformStats, chatLijst, chatStuur, onboarding, dienstIn, dienstUit, dienstNu, wereld, wereldActie, opdrachtVoorDoos, audit, KAMER_IDS } };
};
