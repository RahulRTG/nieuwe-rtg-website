...
module.exports = ({ db, save, crypto, anthropic, ledenAantal, accounts, keyVanCodenaam }) => {
  ...
  const ctx = { db, save, crypto, anthropic, ledenGeteld, nu, DAG, lijst, tel, recent, d, AFDELINGEN, KAMER_IDS, functies, accounts, keyVanCodenaam };
