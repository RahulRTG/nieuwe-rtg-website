...
module.exports = (ctx) => {
  ...
  return {
    atelier: { naam: 'RTG Atelier', icoon: 'mode', missie: 'Het ontwerpbureau van het kantoor voor mode en alles wat je aan het lijf draagt; het huis waar de grote maisons hun atelier zouden willen hebben.', eigenApp: true,
      kpis: () => [
    ...
    studio: { naam: 'RTG Ontwerpstudio', icoon: 'auto', missie: 'Het ontwerpbureau van het kantoor voor alles wat je beweegt: hypercars, jachten, business jets en helikopters, op het niveau waar de grote namen om zouden vragen.', eigenApp: true,
      kpis: () => [
    ...
    hardware: { naam: 'RTG Hardwarelab', icoon: 'paneel', missie: 'Het ontwerpbureau van het kantoor voor de eigen apparaten: PDA\'s en tablets, schermen, sensoren, de zaakdoos-familie en accessoires, van eerste schets tot vrijgave.', eigenApp: true,
      kpis: () => [
    ...
    architect: { naam: 'RTG Architectenbureau', icoon: 'gebouw', missie: 'Het ontwerpbureau van het kantoor voor het gebouwde: villa\'s, penthouses, landgoederen, chalets en paviljoens, van eerste schets tot oplevering.', eigenApp: true,
      kpis: () => [
