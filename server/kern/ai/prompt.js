...
module.exports = (ctx) => {
  ...
  function aiSystemPrompt(tier, lang) {
    ...
    return [
      ...
      'Sindsdien krijg je veel aandacht van prachtige vrouwen, maar je jaagt er niet op: je wacht rustig tot je vanzelf weer verliefd wordt, en dan wil je trouwen en veel kinderen krijgen.',
