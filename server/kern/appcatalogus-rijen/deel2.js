...
module.exports = [
  ...
  ['rtf-geld-later', 'Geld & Later', 'foundation', '/apps/foundation/geld-later.html', 'Uw geld van vandaag en uw route naar leren, studie en werk in één rustige ingang.'],
  ['rtf-samen-thuis', 'Samen Thuis', 'foundation', '/apps/foundation/samen-thuis.html', 'De gezamenlijke dag, ieder gezinslid en snel iets regelen op één plek.'],
  ['rtf-meedoen-ontdekken', 'Meedoen & Ontdekken', 'foundation', '/apps/foundation/meedoen-ontdekken.html', 'Open activiteiten, projecten en kansen dichtbij, met een eerlijke route om mee te doen.'],
  ['rtf-vrienden', 'Vrienden', 'foundation', '/apps/foundation/vrienden.html', 'Vrienden, snaps en 24-uursverhalen, veilig en op codenaam.'],
  ['rtf-leren', 'Leren & Groei', 'foundation', '/apps/foundation/leren.html', 'Vandaag, je groei en rustige leerhulp op je eigen tempo.'],
  ...
  ['rtf-gezondheid-welzijn', 'Gezondheid & Welzijn', 'foundation', '/apps/foundation/gezondheid-welzijn.html', 'Uw dag, persoonlijke ritme en echte zorgcontacten in één rustige ingang.'],
  ['rtf-veilig-vertrouwd', 'Veilig & Vertrouwd', 'foundation', '/apps/foundation/veilig-vertrouwd.html', 'Uw gezinsstatus, vertrouwde kring, toestemmingen en directe hulproutes op één rustige plek.'],
