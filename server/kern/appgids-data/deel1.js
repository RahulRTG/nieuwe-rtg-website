...
module.exports = {
  ...
  '/apps/rtmail.html': G('RTMAIL: je eigen postvak binnen RTG, op je codenaam. Hier komt je welkom en houdt Rahul je op de hoogte.',
    ['Open een bericht om het te lezen; het wordt dan als gelezen gemarkeerd', 'Je vindt RTMAIL ook als kanaal in de Berichten-app, tussen je andere gesprekken', 'RTMAIL bezorgt en bewaart; geld en toegang regel je altijd zelf in de bron-app'],
    'Alles op codenaam: je echte naam blijft in de kluis, ook in je post.'),
