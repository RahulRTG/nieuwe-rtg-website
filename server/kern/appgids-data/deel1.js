...
module.exports = {
  ...
  '/apps/rtg.html': G('Ontdek RTG: de website van het huis, nu als app in je eigen bureaublad -- het verhaal, de drie passen en het hele ecosysteem.',
    ['Lees waar RTG voor staat: een reishuis op lidmaatschap', 'Vergelijk de drie passen (RTG, Lifestyle, Business) en hun toon', 'Spring van hieruit naar de 3D-signatuur: het uitzicht en het horloge'],
    'Dit is de publieke pagina van RTG, maar dan als app: hetzelfde verhaal, in de donkere huisstijl van het bureaublad.'),
