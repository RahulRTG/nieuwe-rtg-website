...
module.exports = {
  ...
  '/apps/balans.html': G('RTG Balans: je week op rust en ritme, niet op geld.',
    ['Zie hoeveel lege dagen je komende week heeft', 'Vraag Rahul een rustmoment in te plannen',
      'Vraag hem naar sport en wellness op een lege dag'],
    'Niks doen is ook een afspraak. Er zijn geen streaks en geen scores; dit scherm mag je gerust negeren.'),
