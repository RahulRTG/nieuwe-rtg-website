...
module.exports = Object.assign({
  ...
  '/apps/rtg.html': G('RTG: reizen, sociaal, leven, veilig, geld en media als zes standen van één premium leden-app.',
    ['Bekijk op Vandaag alleen wat aandacht vraagt', 'Wissel links direct tussen de zes standen', 'Open vanuit iedere stand de volledige specialistische werkruimte'],
    'Eén voordeur verandert geen rechten: iedere onderliggende dienst houdt zijn eigen gegevenspoort en toestemming.'),
  ...
  '/apps/reisuitnodiging.html': G('Een klaargezette reis aannemen: het reisbureau of een reisgenoot heeft een reis voor je klaargezet.',
    ['Open de link die je kreeg en bekijk waar en wanneer', 'Word lid (of log in) en neem de reis over', 'Daarna staat alles in je eigen reisoverzicht'],
    'De link laat bewust weinig zien; de volledige reis verschijnt pas nadat je hem hebt overgenomen.'),
