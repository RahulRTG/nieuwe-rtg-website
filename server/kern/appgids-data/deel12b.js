...
module.exports = {
  ...
  '/apps/mijn-neigingen.html': G('Mijn neigingen: de vragen die zichzelf afkappen, en wat RTG van je DENKT te weten.',
    ...
    'Dit gaat over NEIGINGEN en niet over gegevens: je naam, adres en documenten staan onder "Wat weet RTG van mij". Wat je zelf hebt gezegd vervalt niet vanzelf; wat RTG heeft afgeleid wel.'),
  '/apps/mijn-relaties.html': G('Wie heeft toegang tot mij: alles wat er op dit moment openstaat, per partij of per soort, en wie er iets van je heeft opgevraagd.',
    ['Zie per partij of per soort wat er mag en tot wanneer',
     'Vraag de gevolgen op voordat je een relatie sluit, of trek een losse toestemming in',
     'Lees op de inzagekaart wie er keek, en neem die mee als bestand'],
