...
module.exports = {
  ...
  '/apps/livinglab.html': G('Het RTF Living Lab: het onderzoeksplatform van de stichting, per stad, waar bewoners en professionals samen echte problemen onderzoeken.',
    ['Start een onderzoek in een van de twaalf soorten, van sensoren tot sociale cohesie', 'Doorloop de vaste cyclus van tien stappen; het systeem zegt per stap wat er nog ontbreekt', 'Hang bewijs onder elke conclusie en laat een mens tekenen wat een handtekening vraagt'],
    'De voorkant mag speels zijn, de achterkant is een onderzoeksinstituut: een mooi verhaal wordt hier geen feit.'),
  '/apps/labpas.html': G('Mijn Living Lab: het scherm van de bewoner die als medeonderzoeker meedoet, op een labpas en zonder account.',
    ['Open uw onderzoek met de labpas die u heeft gekregen', 'Stuur observaties in, en vooral: leg vast wat misging of wat u eerder verkeerd dacht', 'Draag een onderzoeksvraag aan voor uw buurt en stem op die van anderen'],
    'Punten verdient u niet met veel insturen maar met goed werk: een bron natrekken, iemand echt spreken, een conclusie durven herzien.'),
