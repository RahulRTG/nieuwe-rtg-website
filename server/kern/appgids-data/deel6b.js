...
module.exports = {  '/apps/oog.html': G('RTG Eye: camera-visie op je toestel, voor voertuigschouw en werkvloerlog.',
  ...
  '/apps/move.html': G('RTG Move: niet waar u heen gaat maar of u het HAALT - per overgang in uw reis een oordeel, met de dekking erbij.',
    ['Zie per overgang hoeveel tijd u hebt en hoeveel u nodig hebt',
      'De dekking zegt over welk deel van uw reis Move iets kon zeggen; de rest is niet onbekend maar ongemeten',
      'Ga verder brengt u naar de volgende plek in Navigatie; Move verzet zelf niets'],
    'Een krappe overgang is geen fout maar een waarschuwing: een reservering verzetten raakt een tweede persoon, dus dat blijft mensenwerk.'),
  ...
  '/apps/vonk.html': G('RTG Vonk: niet meer mensen, sneller de juiste - met een plek precies in het midden.',
    ['Zeg per onderwerp wat verplicht is, wat een sterke voorkeur en wat leuk meegenomen',
      'Elke dag hooguit zes mensen die wederzijds passen, met de reden erbij waarom je ze ziet',
      'Bij een wederzijdse like kiezen jullie blind uit drie plekken op gelijke reistijd'],
    'Wat je van een ander vraagt ziet niemand; van je eigen antwoorden bepaal je zelf per onderwerp wie ze mag zien.'),
