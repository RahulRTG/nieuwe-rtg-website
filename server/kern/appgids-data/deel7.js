...
module.exports = {
  ...
  '/apps/routedekking.html': G('De routedekking: elke route die dit huis heeft, en of een toets hem ooit echt heeft aangeroepen.',
    ['Lees de stand: in orde, niet 100% of niet gemeten',
     'Zoek een route op, of filter op alleen de routes zonder toets',
     'Kijk per domein waar de gaten zitten'],
    'Het cijfer is geen bewaard getal maar een vergelijking: het bewijsstuk van de laatste testronde naast de routes die deze server nu registreert. Een route erbij zonder toets valt hier meteen op.'),
  '/apps/routedossier.html': G('Het routedossier: wat we van elke route werkelijk weten, over elf schakels.',
    ['Lees per schakel hoeveel routes bewezen zijn en hoeveel ongemeten',
     'Klik een schakel aan om alleen de routes te zien waar die schakel op staat',
     'Open een route voor zijn volledige dossier, met per schakel de bron en de reden'],
    'Ongemeten betekent niet onveilig: het betekent dat niemand het heeft nagevraagd. Twee schakels staan voor elke route op ongemeten omdat er nog geen instrument voor bestaat, en dat zegt het scherm er zelf bij.'),
  ...
  '/apps/mijn-sessies.html': G('Waar ben ik aanwezig: alle sessies waarmee er op jouw account gewerkt kan worden, en de knop om er een te sluiten.',
    ['Zie per sessie waarmee er is ingelogd en wanneer die voor het laatst actief was',
     'Sluit een sessie die je niet herkent; dat toestel moet daarna opnieuw inloggen',
     'Of sluit in een keer alles behalve deze'],
    'Bij elk onderdeel staat hoe zeker RTG het weet. Wat wij nooit hebben vastgesteld heet onbekend; daar vullen wij niets voor in.'),
