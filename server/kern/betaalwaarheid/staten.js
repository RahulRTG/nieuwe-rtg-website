...
const OVERGANGEN = {
  ...
  /* Een mislukte kaartpoging is niet altijd het einde van dezelfde
     PaymentIntent. De klant kan met een andere methode opnieuw bevestigen en
     daarna volgt alsnog een ondertekende succeeded-melding. */
  GEWEIGERD: ['WACHT_OP_KLANT', 'IN_BEHANDELING', 'BEVESTIGD', 'CONTROLE_NODIG'],
