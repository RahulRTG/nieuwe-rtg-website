...
const REDEN = {
  ...
  /* Een prijsNIVEAU is geen ontbrekende prijs maar een andere soort. "Vanaf 12
     euro per gerecht" zegt wat voor zaak dit is; je koopt geen restaurant. Hier
     valt niets te repareren, en "zet een prijs" zou een ondernemer aan het werk
     zetten aan iets wat niet bestaat. */
  prijsNiveau: 'Dit bedrag is een prijsniveau en geen prijs: het zegt wat een gerecht hier ongeveer kost. Een zaak zelf staat niet te koop; wat u hier doet is reserveren, en bestellen gebeurt aan tafel.',
  bevestigNiveau: 'Een zaak is geen artikel. Reserveren kan wel, en de gerechten rekent u daar af.',
