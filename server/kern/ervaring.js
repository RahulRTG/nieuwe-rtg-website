...
function maakErvaring({ db, save, crypto, findSupplier, notify, notifySupplier, sseToCustomer, sseToSupplier, sseToOffice, zijnVrienden, ticketsVoorSlot, optieAan, tafeldekVan, payVan, codenaamVan }) {
  ...
  const ctx = { db, save, findSupplier, notify, notifySupplier, sseToCustomer, sseToSupplier, sseToOffice,
    zijnVrienden, ticketsVoorSlot, optieAan, tafeldekVan, payVan, codenaamVan, orderMetRef, boekingMetRef, boekingenVanKlant,
