/* Ervaring-deel "leden" (kern/ervaring): annuleren, reviews, favorieten,
   fooi, de reisagenda, rekening splitsen, de wachtlijst, RTG-punten en de
   meldingsvoorkeuren. Verbatim afgesplitst uit kern/ervaring.js. */
module.exports = (ctx) => {
  ...
  return { annuleerItem, plaatsReview, reviewsVoor, ratingVan, reviewReageer,
    toggleFavoriet, favorietenVan, isFavoriet, fooiUit, agendaVoor,
