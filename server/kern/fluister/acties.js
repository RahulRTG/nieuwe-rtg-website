/* De Butler-acties (kern/fluister): het doe-deel van de assistent. voerUit
   voert een bevestigd voorstel uit (Tik, 24-uursblok) en fluisterZeg verstaat
   de vraag, antwoordt (Claude of eigen regels) en handelt met de drempel:
   alles met geld of een poolclaim wordt eerst een voorstel dat u met "ja"
   bevestigt. Verbatim afgesplitst uit kern/fluister.js; het geheugen en de
   seintjes wonen daar en komen via de context binnen. */
module.exports = (ctx) => {
