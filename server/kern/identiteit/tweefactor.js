...
/* De codes zelf -- het geheim en de tien herstelcodes -- worden in
   ./tweefactor-codes.js gemaakt; daar staat ook waarom de trekking van een
   herstelcode VERWERPT in plaats van rest te delen. Dit bestand bewaakt alleen. */
const { nieuweCode, nieuwGeheim, hashVan, schoon, CODES } = require('./tweefactor-codes');
