...
module.exports = (ctx) => {
  ...
  const NIEUWE_TYPES = {
    ...
    galerie:     { label: 'Kunst & galerie', icon: '\u{1F5BC}', caps: ['tickets', 'retail', 'location', 'pricing'] },
    ...
    fitnessclub: { label: 'Sport & fitnessclub', icon: '\u{1F3CB}', caps: ['fitclub', 'location', 'pricing'] },
    beautysalon: { label: 'Beauty-salon & barbier', icon: '\u{2702}', caps: ['beauty', 'location', 'pricing'] },
    ...
    professioneel: { label: 'Professionele diensten', icon: '\u{2696}', caps: ['advies', 'location', 'pricing'] },
    verzekeringen: { label: 'Verzekeringen (advies)', icon: '\u{1F6E1}', caps: ['polis', 'location', 'pricing'] },
    wintersport: { label: 'Wintersport & seizoensresort', icon: '\u{26F7}', caps: ['alpine', 'location', 'pricing'] }
  };
