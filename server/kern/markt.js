...
function maakMarkt({ db, save, crypto, anthropic, schoon, notify, notifySupplier }) {
  function store() {
  ...
  function chatPub(chat, kijker) {
    ...
    return {
      ...
      berichten: chat.berichten.map(b => ({ mijn: b.van === kijkerKey, naam: b.naam, tekst: b.tekst, at: b.at, let: !!b.let }))
    };
  }
