...
module.exports = ({ db, boekingenVanZaak, ordersVanZaak, intakeOntbreekt }) => {
  ...
  function dagbeeld(o, beeld, verk, project, eersteklant, mall, rel, deb, cred, con, bel, kas, cap, wrv, pij, bst, vrd, klu, tgn) {
    ...
    return {
      ...
      acties: acties(o, feiten, verk, project, eersteklant, mall, rel, deb, cred, con, bel, kas, cap, wrv, pij, vrd, klu, tgn),
