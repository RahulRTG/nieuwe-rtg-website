...
module.exports = ({ db, boekingenVanZaak, ordersVanZaak, intakeOntbreekt }) => {
  ...
  /* ---- de acties ----
     Op volgorde van gewicht. Elke actie zegt WAAROM hij er staat: een lijstje
     opdrachten zonder reden wordt een afvinklijst, en dan verdwijnt ook de
     belangrijke erin. */
  function acties(o, feiten, verk) {
    const uit = [];
    ...
    if (o.kvk && !o.supplierCode) {
      zet('koppel-zaak', 'Koppel uw zaak',
        'U bent ingeschreven, maar er hangt nog geen werkende zaak aan deze onderneming.', 'zaak');
    }
    // 7. wat er ligt
    if (o.supplierCode) {
  ...
  function dagbeeld(o, beeld, verk) {
