...
module.exports = ({ db, boekingenVanZaak, ordersVanZaak, intakeOntbreekt }) => {
  ...
  function dagbeeld(o, beeld, verk, project, eersteklant, mall, rel, deb, cred, con, bel, kas, cap) {
    ...
    return {
      ...
      acties: acties(o, feiten, verk, project, eersteklant, mall, rel, deb, cred, con, bel, kas, cap),
