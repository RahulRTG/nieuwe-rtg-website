...
module.exports = (ctx) => {
  ...
  /* De AI-griffier (helpt met het beeld, oordeelt nooit) staat apart, in
     ./rechtbank-ai.js; die krijgt het cockpit-beeld en de helpers mee. */
  const rbAI = require('./rechtbank-ai')({ anthropic, schoon, rbCockpit });
