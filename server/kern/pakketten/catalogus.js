/* RTG Bedrijfspakketten -- de catalogus (pure data). Het arsenaal aan technieken,
   de werk-apps en de bedrijfstypen met hun indeling. Los te toetsen, geen logica.
   Zie kern/pakketten.js voor de motor die hier het advies uit opbouwt.

   BEROEPSGEHEIM: dit beschrijft UITSLUITEND wat de zaak van het lid krijgt; de
   interne werking van de RTG-kantoren zelf komt hier nooit in voor. */
...
/* De bedrijfstypen. `indeling` beschrijft de 3D-plattegrond: kamers op een raster
...
module.exports = { TECHNIEK, APP, TYPEN };
