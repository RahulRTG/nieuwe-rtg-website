...
/* De rechten van een mens over zijn eigen account stonden hier ook, en zijn
   verhuisd naar ./bediening-recht.js -- zelfde uitkomst (niet schakelbaar), andere
   grond (niet "de machine gaat stuk" maar "dat mag RTG een mens niet afnemen").
   Ze worden hieronder weer aangeplakt, zodat er EEN lijst naar buiten gaat en
   ../platformregister.js en scripts/activering.js niets hoeven te weten van de
   knip. */
const RECHT = require('./bediening-recht');
