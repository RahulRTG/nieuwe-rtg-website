...
module.exports = ({ db, save, findSupplier, anthropic }) => {
  ...
  function schaal(niveau, door) {
    ...
    if (niveau === 'normaal' && vorig !== 'normaal') uit.evaluatie = evaluatie(null);
    return uit;
  }

  /* Het naoefening-rapport: reconstrueert uit de bestaande gegevens wat er is
     gebeurd. Puur om van te leren; geen namen, alleen operationele cijfers. */
  ...
  return { rampbeeld: { NIVEAUS, beeld, schaal, coordinatorAi, evaluatie: evaluatieVoor } };
};
