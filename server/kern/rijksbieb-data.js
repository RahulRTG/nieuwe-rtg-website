...
const AFDELINGEN = [
  { id: 'belastingdienst', label: 'Belastingdienst', icon: 'rekening',
  ...
  { id: 'toeslagen', label: 'Dienst Toeslagen', icon: 'rechterhand',
  ...
  { id: 'kvk', label: 'KVK & Handelsregister', icon: 'gebouw',
  ...
  { id: 'sociaal', label: 'UWV & SVB', icon: 'schild',
  ...
  { id: 'provincie', label: 'Provincie', icon: 'oogst',
  ...
  { id: 'waterschap', label: 'Waterschap', icon: 'balans',
  ...
  { id: 'rechtspraak', label: 'De Rechtspraak', icon: 'juridisch',
  ...
  { id: 'gemeenten', label: 'Gemeenten', icon: 'gebouw',
  ...
  { id: 'bestuur', label: 'Bestuur & Berichtenbox', icon: 'berichten',
  ...
  { id: 'facilitair', label: 'Rijkskantoren & Facilitair', icon: 'sleutel',
  ...
  { id: 'ict', label: 'Digitale Overheid & ICT', icon: 'paneel',
