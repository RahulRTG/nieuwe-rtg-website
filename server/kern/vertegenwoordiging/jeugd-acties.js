...
module.exports = (h) => {
  ...
  /* DE VIERDE HANDELING STAAT IN ./jeugd-tekent.js, en dat is dezelfde naad die
     de kop hierboven al trekt: deze drie gaan over WIE de voogd is, die ene
     over een MACHTIGING. Zie de kop daar voor waarom de volgorde -- de jongere
     eerst -- geen validatievolgorde is maar de regel zelf. */
  const { voogdTekent } = require('./jeugd-tekent')({ vastleggen, nu, naam, spoor, zoekAlsVoogd });
