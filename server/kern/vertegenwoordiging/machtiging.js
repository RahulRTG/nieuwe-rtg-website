...
/* WAT JE MET EEN MACHTIGING KAN -- de doorsnede en het oordeel per handeling --
   staat in ./machtiging-gebruik.js. Dezelfde naad als ./jeugd.js tegenover
   ./jeugd-acties.js: hier staat wat een machtiging IS, daar wat je ermee KAN. */
const { versmalMachtiging, magHandelen } = require('./machtiging-gebruik')({ stand });
