/* FOUNDATION CONNECT -- de mutatiecontracten, deel vier: de horizon en de kring.

   Uit ./mutatiecontracten-connect3.js geknipt op de 10 kB-grens
   (keuringsregel 13). Deze twee zijn een eigen soort: ze bewaren geen
   gebeurtenis maar een KEUZE -- en de kring bewaart zelfs dat niet, want
   kern/connect/kring.js rekent alleen.

   De bouwstenen staan hier opnieuw en niet geimporteerd, om dezelfde reden als
   in deel twee en drie: ./idemsleutels-eenmaal.js bewaakt dat een route niet in
   twee zijbestanden staat, en een gedeelde bouwsteen tussen registerbestanden
   maakt de ene stil afhankelijk van de volgorde van de andere.
   ========================================================================== */
'use strict';
