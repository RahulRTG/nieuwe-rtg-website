...
const actie = {
  ...
  waarom: 'Only documents.trash and documents.restore; owner policy before durable replay; state and receipt in one collection transaction.',
...
module.exports = { CONTRACTEN: {
  ...
  'POST /api/bestanden/wis': {
    ...
    watErMoetKomen: 'A separate purge fixture must interrupt blob/metadata erasure and verify recovery, backup retention and audit. This trash/restore certification does not exercise destructive erasure.',
