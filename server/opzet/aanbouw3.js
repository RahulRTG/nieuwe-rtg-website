...
module.exports = function bouwKernAanDrie(kern, grens) {
  ...
  /* De identiteits- en toestemmingsstapel staat in ./aanbouw4.js en komt als
     LAATSTE, want alles hierboven moet er al zijn: Life, de dagcoach en de
     tijdlijn krijgen de kern mee en lezen wat hier is gemonteerd. */
  require('./aanbouw4')(kern, grens);
};
