...
module.exports = function maakDiensten(deps) {
  ...
  const {
    ...
    resolveSession, mailQ, mailIn, rtmail, rtmailTeam, rtmailVak, rtmailDraad, rtmailSchrijf, rtmailRegels, rtmailDossier, rtmailSla, rtmailRecht, rtmailBewaar, scanNet, wacht, werkmail
