...
kern.overheid.seed();
/* registreerVloot() STOND HIER en deed op een verse installatie niets: de
   verhuurzaken komen pas uit initRealtime(). Nu in opzet/opslagstart.js, na de
   zaai. Toedracht: test/gietvorm.test.js. */
};
