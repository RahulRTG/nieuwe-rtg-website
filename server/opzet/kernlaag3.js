...
/* De vier samenhanglagen (reiswereld, kantoorwereld, socialewereld,
   geldwereld) staan in ./kernlaag3c.js. Ze stonden hier, en ze staan daar op
   exact dezelfde plek in de volgorde -- alleen in een eigen bestand, omdat dit
   bestand bij het samenvoegen met main over de omvangregel ging. De knip loopt
   langs een echte naad: dat zijn de vier lagen die niets bezitten en nooit
   schrijven. Geldbeleid en geldgraaf komen er in ./kernlaag3b.js achteraan. */
require('./kernlaag3c')(kern);
};
