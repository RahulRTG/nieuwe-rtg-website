...
module.exports = (kern, hulp) => {
  const { FISCAAL_PEILJAAR, LANDEN, accounts, anthropic, betaal, bijeen, centen, crypto, db, findSupplier, fonds, keyVanCodenaam, ledenAantal, log, save, schoon, sseToCustomer, sseToOffice, sseToSupplier } = hulp;
...
Object.assign(kern, require('../kern/bank')({ db, save, bijeen, crypto, schoon, betaal, pay: kern.pay, bankregie, keyVanCodenaam, accounts, sseToCustomer, sseToOffice, anthropic }));
