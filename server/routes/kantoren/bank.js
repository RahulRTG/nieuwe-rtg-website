...
module.exports = (ctx) => {
  ...
  /* De twee handelingen die een tweede mens vragen, plus het loket waar die
  ...
  // MONEY-012: een ONBEKENDE uitbetaling afstemmen op een afschriftregel, met vier ogen
  require('./bank-afstemming')(Object.assign({}, ctx, { naam }));
