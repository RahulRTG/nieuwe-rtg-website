...
module.exports = (ctx) => {
  ...
  /* RTG Redactie: het persbureau (kern/redactie.js). De schrijftafel met de
     statusketen (publiceren beslist een mens), de drukkerij met edities en
     drukproef, de nieuwstips-wand uit het hele platform en de AI-hoofdredacteur. */
