...
module.exports = (kern) => {
  const { app, auth, geenGast, magnaatLeven } = kern;
  ...
  app.post('/api/member/magnaat/leven/staat', auth, (req, res) => alsLid(req, res, key => magnaatLeven.staat(key)));
  app.post('/api/member/magnaat/leven/actie', auth, (req, res) => alsLid(req, res, (key, b) => magnaatLeven.actie(key, b)));
};
