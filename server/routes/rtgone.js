module.exports = (kern) => {
  ...
  app.post('/api/rtgone/goedkeuring/beslis', officeAuth, (req, res) => veilig(res, () => rtgone.goedkeuringBeslis(req.body.id, req.body.besluit, context(req), req.body || {})));
  ...
  app.post('/api/rtgone/project/bewijs', officeAuth, (req, res) => veilig(res, () => rtgone.projectBewijs(req.body || {}, context(req))));
  app.post('/api/rtgone/project/oplever', officeAuth, (req, res) => veilig(res, () => rtgone.projectOplever(req.body || {}, context(req))));
