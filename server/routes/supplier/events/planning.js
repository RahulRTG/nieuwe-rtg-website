...
module.exports = (kern) => {
  const { anthropic, app, broadcastSync, crypto, fallbackRunsheet, logActivity, managerOnly,
          parseRunsheetText, runItem, save, sortRunsheet, sseToSupplier, supplierAuth } = kern;
