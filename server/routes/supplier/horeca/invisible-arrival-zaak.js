...
/* GEEN db.data HIER. De gastkant raakt de reserveringen al aan en geeft die ene
   opzoeking mee als functie; zo blijft de deur naar db.data op een plek liggen
   in plaats van dat een afsplitsing er een tweede opent (keuringsregel 62 en de
   meter dbDeuren). Opknippen mag geen toegang vermenigvuldigen. */
module.exports = ({ app, supplierAuth, save, schoon, sseToSupplier, nu, lees, publiek, reserveringMet }) => {
