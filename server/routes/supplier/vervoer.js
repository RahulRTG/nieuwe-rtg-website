...
module.exports = (kern) => {
  const { RIT_KETEN, RIT_LEGACY, accounts, app, broadcastSync, db, factuur, logActivity, notify,
          ritBezetting, ritVerder, save, schoon, sseToCustomer, sseToOffice, sseToSupplier, supplierAuth } = kern;
