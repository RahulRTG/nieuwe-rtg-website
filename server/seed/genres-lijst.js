...
module.exports = {
  ...
  wintersport: { label: 'Wintersport & seizoensresort', icon: '\u{26F7}', industry: 'hospitality', caps: ['alpine', 'location', 'pricing'], status: 'binnenkort' },
  ...
  koffie: { label: 'Koffie & patisserie', icon: 'bar', industry: 'horeca', caps: ['menu', 'orders', 'location', 'pricing'], status: 'binnenkort' },
  chef: { label: 'Privéchef & catering', icon: '\u{1F468}\u{200D}\u{1F373}', industry: 'horeca', caps: ['services', 'location', 'pricing'], status: 'binnenkort' },

  // Vervoer
  taxi: { label: 'Taxi', icon: 'auto', industry: 'mobility', caps: ['rides', 'location', 'pricing'], status: 'binnenkort' },
  verhuur: { label: 'Autoverhuur', icon: 'sleutel', industry: 'mobility', caps: ['huur', 'location', 'pricing'], status: 'open' },
  tweewielers: { label: 'Tweewielers & quads', icon: '\u{1F6F5}', industry: 'mobility', caps: ['huur', 'location', 'pricing'], status: 'binnenkort' },
  ...
  vracht: { label: 'Vracht & expeditie', icon: '\u{1F6A2}', industry: 'mobility', caps: ['vracht', 'location', 'pricing'], status: 'binnenkort' },

  // Luchtvaart
  jet: { label: 'Privéjet', icon: 'vluchten', industry: 'aviation', caps: ['rides', 'location', 'pricing'], status: 'binnenkort' },
  helikopter: { label: 'Helikopter transfers', icon: 'vluchten', industry: 'aviation', caps: ['rides', 'fleet', 'location', 'pricing'], status: 'binnenkort' },
  ...
  marina: { label: 'Marina & jachthaven', icon: '\u{2693}', industry: 'maritime', caps: ['marina', 'location', 'pricing'], status: 'binnenkort' },
  ...
  juwelier: { label: 'Juwelier & horloges', icon: '\u{1F48E}', industry: 'retail', caps: ['retail', 'services', 'location', 'pricing'], status: 'binnenkort' },

  // Groothandel
  groothandel: { label: 'Groothandel & markt', icon: 'logistiek', industry: 'wholesale', caps: ['groothandel', 'bezorgen', 'location', 'pricing'], status: 'binnenkort' },

  // Agrarisch
  boerderij: { label: 'Boerderij & landbouw', icon: 'oogst', industry: 'agriculture', caps: ['boerderij', 'location', 'pricing'], status: 'open' },

  // Zorg
  zorg: { label: 'Zorg & welzijn', icon: 'zorg', industry: 'healthcare', caps: ['care', 'location', 'pricing'], status: 'binnenkort' },
  ...
  petcare: { label: 'Petcare & pension', icon: '\u{1F43E}', industry: 'veterinary', caps: ['petcare', 'location', 'pricing'], status: 'binnenkort' },

  // Beauty & wellness
  beautysalon: { label: 'Beauty-salon & barbier', icon: '\u{2702}', industry: 'beauty', caps: ['beauty', 'location', 'pricing'], status: 'binnenkort' },
  beautymedical: { label: 'Beauty medical', icon: '\u{2728}', industry: 'beauty', caps: ['location'], status: 'bewijs' },
  wellness: { label: 'Wellness & spa', icon: '\u{1F9D6}', industry: 'beauty', caps: ['services', 'bookings', 'location', 'pricing'], status: 'binnenkort' },
  ...
  professioneel: { label: 'Professionele diensten', icon: '\u{2696}', industry: 'professional', caps: ['advies', 'location', 'pricing'], status: 'binnenkort' },
  ...
  // Media
  journalistiek: { label: 'Journalistiek', icon: 'nieuws', industry: 'media', caps: ['redactie', 'location', 'pricing'], status: 'binnenkort' },
  ...
  // Events & cultuur
  events: { label: 'Events & festivals', icon: '\u{1F3AA}', industry: 'events', caps: ['tickets', 'rides', 'location', 'pricing'], status: 'binnenkort' },
  activiteit: { label: 'Activiteiten & musea', icon: 'ticket', industry: 'events', caps: ['tickets', 'rides', 'location', 'pricing'], status: 'binnenkort' },
  activiteiten: { label: 'Activiteiten & excursies', icon: 'tickets', industry: 'events', caps: ['tickets', 'location', 'pricing'], status: 'open' },
  galerie: { label: 'Kunst & galerie', icon: '\u{1F5BC}', industry: 'events', caps: ['tickets', 'retail', 'location', 'pricing'], status: 'binnenkort' },
  weddingplanner: { label: 'Weddings & prive-events', icon: '\u{1F492}', industry: 'events', caps: ['weddings', 'location', 'pricing'], status: 'binnenkort' },

  // Sport
  sportclub: { label: 'Sportclub', icon: 'sport', industry: 'sports', caps: ['sportclub'], status: 'binnenkort' },
  golfclub: { label: 'Golf & countryclub', icon: '\u{26F3}', industry: 'sports', caps: ['golf', 'location', 'pricing'], status: 'binnenkort' },
  fitnessclub: { label: 'Sport & fitnessclub', icon: '\u{1F3CB}', industry: 'sports', caps: ['fitclub', 'location', 'pricing'], status: 'binnenkort' }
};
