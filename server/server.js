...
/* De statische serveerlaag (CSP-nonce, gzip-cache, express.static) staat
   als kern-module apart; PUBLIC_DIR en CSP_NONCE blijven hier beschikbaar
   voor het kern-object. */
const { PUBLIC_DIR, CSP_NONCE } = require('./kern/statisch')({ app, express });
