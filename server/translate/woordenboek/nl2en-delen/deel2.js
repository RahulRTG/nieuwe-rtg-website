/* Vertaallaag NL->EN, deel 2 van de seed-inhoud. Zie ../nl2en.js voor waar dit
...
module.exports = {
  ...
  /* De ballotage (de vier vragen van het aanmeldpad): vaste, verzorgde
     vertalingen zodat de verheven toon ook in het Engels gegarandeerd is en
  ...
  'Daar zie ik geen e-mailadres in. Voluit, met @?':
    "I don't see an email address there. In full, with an @?",
  'Genoteerd. Je geboortedatum? Die bepaalt wat er voor je opengaat.':
    'Noted. Your date of birth? It determines what opens up for you.',
  'Die datum kan ik niet plaatsen. Als dag-maand-jaar, bijvoorbeeld 14-03-1992?':
  ...
  'Leuk! Dan regelen we dat hier. Hoe gaat het vandaag?':
    "Lovely! We'll arrange that right here. How are you today?",
  // losse poortzinnen: voor de per-zin-vertaling van gepersonaliseerde regels
