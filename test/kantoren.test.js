/* De RTG-kantoren en de boardroom: zeventien afdelingskamers met echte cijfers,
...
test('zeventien kamers, elk met cijfers; zonder inlog blijft de deur dicht', async () => {
  ...
  assert.equal(d.body.kamers.length, 17, 'zeventien afdelingen');
...
test('de boardroom ziet alles en schakelt echt: functie uit, pad dicht, weer aan', async () => {
  ...
  assert.equal(b.body.kamers.length, 17, 'alle kamers in beeld');
