...
test('set/get gaan over de eigen client', { skip: !HEEFT_REDIS }, async () => {
  ...
  try {
    ...
    /* EVAL hoort bij dezelfde echte-clientproef. Een apart test() met dezelfde
       Redis-poort vergroot alleen het aantal zelf-overslaande toetsen; het
       levert geen extra omgeving of isolatie op. */
