/* DE HERITAGE-ROUTEKAART IS FAIL-CLOSED.
   ...
   hier tegen de werkelijke HTML-boom gehouden: 293 schermen, 17 doorwijzers,
...
test('het manifest dekt 293 echte schermen en 17 redirects precies eenmaal', () => {
  ...
  assert.equal(DOORWIJZERS.length, 17, 'exact 17 oude adressen horen doorwijzers te blijven');
  ...
  assert.equal(identiteit.REDIRECTS.length, 17, 'het redirectmanifest hoort 17 adressen te bevatten');
