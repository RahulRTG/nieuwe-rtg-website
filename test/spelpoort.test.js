...
const LEDEN_SPELACTIES = [
  ...
  '/api/member/spel/staat', '/api/member/spel/zet', '/api/member/spel/opgeven', '/api/member/spel/toewijzen', '/api/member/spel/replay', '/api/member/spel/nabespreking',
...
const RTF_SPELACTIES = [
  ...
  '/api/rtf/spel/staat', '/api/rtf/spel/zet', '/api/rtf/spel/opgeven', '/api/rtf/spel/toewijzen', '/api/rtf/spel/replay', '/api/rtf/spel/nabespreking',
