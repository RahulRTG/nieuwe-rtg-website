...
const GOUD = {
  ...
  magnaat:  ['Magnaat', 6, 'rtg', { werelden: ['rtg', 'rtf'], buitenBeurt: ['bouw', 'verkoop', 'beleid',
    ...
    'hospitality-start', 'hospitality-stap', 'hospitality-chaos',
    'hospitality-besluit', 'hospitality-koppel', 'hospitality-delen',
    'universe-briefing', 'universe-vergelijk', 'universe-evidence',
    'human-open', 'human-ontwikkel', 'human-besluit', 'human-afronden'], vormen: ['live', 'async'],
