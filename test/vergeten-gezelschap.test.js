...
test('vergetelheid werkt voor elke pas, niet alleen voor een RTG-lid', async () => {
  ...
  try {
    ...
    for (const naam of passenLijst) {
      ...
      /* De bezem loopt achter het verzoek aan, dus kijken we tot hij klaar is
         in plaats van tot de klok afloopt. Blijft er werkelijk iets staan, dan
         zakt hij nog steeds -- met dezelfde takken in de melding. Alleen de gok
         over HOE SNEL is eruit. */
      const sporen = () => {
