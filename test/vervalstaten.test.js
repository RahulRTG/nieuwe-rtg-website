/* DE VERVALSTATEN VAN scripts/vertrouwen.js -- de staatmachine achter de bewijspoort.
   Dit bestand heette test/vertrouwen.test.js. Op main kreeg die naam een ander
   onderwerp (server/kern/identiteit/vertrouwen.js, de identiteitsstand) en
   #176 breidde juist de oude scripttoetsen uit. Bij de samenvoeging van
   3 september 2026 zijn beide gehouden: de identiteitstoetsen onder hun naam,
   de scripttoetsen hier -- anders verdween de enige toets op deze staatmachine
   stil, en dat is precies het soort gat dat LAT.md regel 2 verbiedt.
   Draai los: node --test test/vervalstaten.test.js */
